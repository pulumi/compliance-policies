...
HEADERS_STRING="$HEADERS_STRING,@premium-policies/reify,@pulumi/reify"
VALUES_STRING="$VALUES_STRING,$PREMIUM_POLICIES_PACKAGES_DURATION_MS,$PULUMI_RESOURCE_PROVIDERS_DURAITON_MS"
