...
exports.enableServerSideEncryptionBucketKey = exports.configureServerSideEncryptionCustomerManagedKey = exports.configureServerSideEncryptionKMS = exports.enableServerSideEncryption = exports.configureReplicationConfiguration = exports.enableReplicationConfiguration = exports.disallowPublicRead = void 0;
 ...
 */
exports.disallowPublicRead = utils_1.policyRegistrations.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: (0, policy_1.validateResourceOfType)(awsnative.s3.Bucket, function (bucket, args, reportViolation) {
 ...
 */
exports.enableReplicationConfiguration = utils_1.policyRegistrations.registerPolicy({
    resourceValidationPolicy: {
 ...
 * @link https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication.html
 */
exports.configureReplicationConfiguration = utils_1.policyRegistrations.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: (0, policy_1.validateResourceOfType)(awsnative.s3.Bucket, function (bucket, args, reportViolation) {
            if (bucket.replicationConfiguration && bucket.replicationConfiguration.rules) {
                bucket.replicationConfiguration.rules.forEach(function (rule) {
 ...
 */
exports.enableServerSideEncryption = utils_1.policyRegistrations.registerPolicy({
    resourceValidationPolicy: {
 ...
 */
exports.configureServerSideEncryptionKMS = utils_1.policyRegistrations.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: (0, policy_1.validateResourceOfType)(awsnative.s3.Bucket, function (bucket, args, reportViolation) {
            if (bucket.bucketEncryption && bucket.bucketEncryption.serverSideEncryptionConfiguration) {
                bucket.bucketEncryption.serverSideEncryptionConfiguration.forEach(function (serverSideEncryptionConfiguration) {
 ...
 */
exports.configureServerSideEncryptionCustomerManagedKey = utils_1.policyRegistrations.registerPolicy({
    resourceValidationPolicy: {
 ...
 */
exports.enableServerSideEncryptionBucketKey = utils_1.policyRegistrations.registerPolicy({
    resourceValidationPolicy: {
