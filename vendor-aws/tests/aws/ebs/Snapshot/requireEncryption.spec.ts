...
describe("aws.ebs.Snapshot.requireEncryption", function() {
    const policy = policies.aws.ebs.Snapshot.requireEncryption;

    it("name", async function() {
        assertResourcePolicyName(policy, "aws-ebs-snapshot-require-encryption");
    });
    ...
    it("#1 - encrypted snapshot passes", async function() {
