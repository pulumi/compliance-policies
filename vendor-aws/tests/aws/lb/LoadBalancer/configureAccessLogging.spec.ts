...
describe("aws.lb.LoadBalancer.configureAccessLogging", function() {
    const policy = policies.aws.lb.LoadBalancer.configureAccessLogging;

    it("name", async function() {
        assertResourcePolicyName(policy, "aws-lb-loadbalancer-configure-access-logging");
    });
    ...
    it("policy-config-include", async function() {
        ...
        await assertHasResourceViolation(policy, args, { message: "LoadBalancers should have access logging configured and enabled." });
    });
