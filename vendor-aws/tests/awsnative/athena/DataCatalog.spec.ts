...
function getResourceValidationArgs(): ResourceValidationArgs {
    return createResourceValidationArgs(awsnative.athena.DataCatalog, {
        description: "This is a description for awsnative.athena.DataCatalog.",
        type: "LAMBDA",
        parameters: {
...
describe("awsnative.athena.DataCatalog.missingDescription", function() {
    const policy = policies.awsnative.athena.DataCatalog.missingDescription;

    it("name", async function() {
        assertResourcePolicyName(policy, "awsnative-athena-datacatalog-missing-description");
    });
