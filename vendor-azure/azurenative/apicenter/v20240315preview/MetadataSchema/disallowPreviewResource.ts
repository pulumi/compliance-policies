...
import { MetadataSchema } from "@pulumi/azure-native/apicenter/v20240315preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (apicenter.v20240315preview.MetadataSchema).
 *
 * @severity medium
 * @frameworks none
