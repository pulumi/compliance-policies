...
import { Cache } from "@pulumi/azure-native/apimanagement/v20180601preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (apimanagement.v20180601preview.Cache).
 *
 * @severity medium
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-apimanagement-v20180601preview-cache-disallow-preview-resource",
