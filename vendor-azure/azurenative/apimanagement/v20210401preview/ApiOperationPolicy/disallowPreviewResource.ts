...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(ApiOperationPolicy, (_, args, reportViolation) => {
            reportViolation("Azure ApiOperationPolicy shouldn't use an unstable API (apimanagement.v20210401preview.ApiOperationPolicy). A compatible replacement can be found at 'apimanagement.ApiOperationPolicy'.");
        }),
    },
    vendors: ["azure"],
