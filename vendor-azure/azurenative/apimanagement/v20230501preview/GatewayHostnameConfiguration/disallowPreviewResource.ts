...
import { GatewayHostnameConfiguration } from "@pulumi/azure-native/apimanagement/v20230501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (apimanagement.v20230501preview.GatewayHostnameConfiguration).
 *
 * @severity medium
 * @frameworks none
