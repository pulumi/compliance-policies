...
import { WorkspaceProductGroupLink } from "@pulumi/azure-native/apimanagement/v20230501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (apimanagement.v20230501preview.WorkspaceProductGroupLink).
 *
 * @severity medium
 * @frameworks none
