...
import { WorkspaceNotificationRecipientUser } from "@pulumi/azure-native/apimanagement/v20230901preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (apimanagement.v20230901preview.WorkspaceNotificationRecipientUser).
 *
 * @severity medium
 * @frameworks none
