...
import { DaprSubscription } from "@pulumi/azure-native/app/v20230801preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (app.v20230801preview.DaprSubscription).
 *
 * @severity medium
 * @frameworks none
