...
import { ConnectedEnvironmentsDaprComponent } from "@pulumi/azure-native/app/v20240202preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (app.v20240202preview.ConnectedEnvironmentsDaprComponent).
 *
 * @severity medium
 * @frameworks none
