...
import { ConfigurationStore } from "@pulumi/azure-native/appconfiguration/v20230801preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (appconfiguration.v20230801preview.ConfigurationStore).
 *
 * @severity medium
 * @frameworks none
