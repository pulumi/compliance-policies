...
import { ApplicationLiveView } from "@pulumi/azure-native/appplatform/v20231101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (appplatform.v20231101preview.ApplicationLiveView).
 *
 * @severity medium
 * @frameworks none
