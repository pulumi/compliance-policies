...
import { DevToolPortal } from "@pulumi/azure-native/appplatform/v20231101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (appplatform.v20231101preview.DevToolPortal).
 *
 * @severity medium
 * @frameworks none
