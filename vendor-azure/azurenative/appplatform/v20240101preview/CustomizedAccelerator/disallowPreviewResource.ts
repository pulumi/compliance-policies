...
import { CustomizedAccelerator } from "@pulumi/azure-native/appplatform/v20240101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (appplatform.v20240101preview.CustomizedAccelerator).
 *
 * @severity medium
 * @frameworks none
