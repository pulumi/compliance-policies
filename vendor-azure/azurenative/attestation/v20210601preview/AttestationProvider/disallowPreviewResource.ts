...
import { AttestationProvider } from "@pulumi/azure-native/attestation/v20210601preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(AttestationProvider, (_, args, reportViolation) => {
            reportViolation("Azure AttestationProvider shouldn't use an unstable API (attestation.v20210601preview.AttestationProvider). A compatible replacement can be found at 'attestation.AttestationProvider'.");
        }),
    },
    vendors: ["azure"],
