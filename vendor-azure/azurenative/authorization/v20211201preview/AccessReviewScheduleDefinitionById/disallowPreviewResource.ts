...
import { AccessReviewScheduleDefinitionById } from "@pulumi/azure-native/authorization/v20211201preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(AccessReviewScheduleDefinitionById, (_, args, reportViolation) => {
            reportViolation("Azure AccessReviewScheduleDefinitionById shouldn't use an unstable API (authorization.v20211201preview.AccessReviewScheduleDefinitionById). A compatible replacement can be found at 'authorization.AccessReviewScheduleDefinitionById'.");
        }),
    },
    vendors: ["azure"],
