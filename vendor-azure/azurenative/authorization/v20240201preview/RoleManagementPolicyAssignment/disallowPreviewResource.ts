...
import { RoleManagementPolicyAssignment } from "@pulumi/azure-native/authorization/v20240201preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (authorization.v20240201preview.RoleManagementPolicyAssignment).
 *
 * @severity medium
 * @frameworks none
