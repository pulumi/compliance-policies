...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(ConfigurationProfile, (_, args, reportViolation) => {
            reportViolation(
                "Azure ConfigurationProfile shouldn't use an unstable API (automanage.v20210430preview.ConfigurationProfile). A compatible replacement can be found at 'automanage.v20220504.ConfigurationProfile'."
            );
        }),
    },
    vendors: ["azure"],
