...
import { ActiveDirectoryConnector } from "@pulumi/azure-native/azurearcdata/v20240501preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(ActiveDirectoryConnector, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure ActiveDirectoryConnector shouldn't use an unstable API (azurearcdata.v20240501preview.ActiveDirectoryConnector). A compatible replacement can be found at 'azurearcdata.ActiveDirectoryConnector'."
            );
        }),
    },
    vendors: ["azure"],
