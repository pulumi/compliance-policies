...
import { SqlManagedInstance } from "@pulumi/azure-native/azurearcdata/v20240501preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(SqlManagedInstance, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure SqlManagedInstance shouldn't use an unstable API (azurearcdata.v20240501preview.SqlManagedInstance). A compatible replacement can be found at 'azurearcdata.SqlManagedInstance'."
            );
        }),
    },
    vendors: ["azure"],
