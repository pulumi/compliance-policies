...
import { Pipeline } from "@pulumi/azure-native/azuredatatransfer/v20231011preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (azuredatatransfer.v20231011preview.Pipeline).
 *
 * @severity medium
 * @frameworks none
