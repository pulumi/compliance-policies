...
import { Fleet } from "@pulumi/azure-native/azurefleet/v20240501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (azurefleet.v20240501preview.Fleet).
 *
 * @severity medium
 * @frameworks none
