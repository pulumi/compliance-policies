...
import { AzureLargeInstance } from "@pulumi/azure-native/azurelargeinstance/v20240801preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (azurelargeinstance.v20240801preview.AzureLargeInstance).
 *
 * @severity medium
 * @frameworks none
