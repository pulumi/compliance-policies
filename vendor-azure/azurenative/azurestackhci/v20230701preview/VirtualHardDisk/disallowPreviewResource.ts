...
import { VirtualHardDisk } from "@pulumi/azure-native/azurestackhci/v20230701preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(VirtualHardDisk, (_, args, reportViolation) => {
            reportViolation(
                "Azure VirtualHardDisk shouldn't use an unstable API (azurestackhci.v20230701preview.VirtualHardDisk). A compatible replacement can be found at 'azurestackhci.VirtualHardDisk'."
            );
        }),
    },
    vendors: ["azure"],
