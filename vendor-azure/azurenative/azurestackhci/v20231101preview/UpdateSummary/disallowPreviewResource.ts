...
import { UpdateSummary } from "@pulumi/azure-native/azurestackhci/v20231101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (azurestackhci.v20231101preview.UpdateSummary).
 *
 * @severity medium
 * @frameworks none
