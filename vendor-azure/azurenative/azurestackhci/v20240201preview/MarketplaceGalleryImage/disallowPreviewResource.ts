...
import { MarketplaceGalleryImage } from "@pulumi/azure-native/azurestackhci/v20240201preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (azurestackhci.v20240201preview.MarketplaceGalleryImage).
 *
 * @severity medium
 * @frameworks none
