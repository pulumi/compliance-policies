...
import { VirtualMachineInstance } from "@pulumi/azure-native/azurestackhci/v20240501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (azurestackhci.v20240501preview.VirtualMachineInstance).
 *
 * @severity medium
 * @frameworks none
