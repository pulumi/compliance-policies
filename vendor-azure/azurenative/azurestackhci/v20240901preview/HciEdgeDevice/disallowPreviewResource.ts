...
import { HciEdgeDevice } from "@pulumi/azure-native/azurestackhci/v20240901preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(HciEdgeDevice, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure HciEdgeDevice shouldn't use an unstable API (azurestackhci.v20240901preview.HciEdgeDevice). A compatible replacement can be found at 'azurestackhci.HciEdgeDevice'."
            );
        }),
    },
    vendors: ["azure"],
