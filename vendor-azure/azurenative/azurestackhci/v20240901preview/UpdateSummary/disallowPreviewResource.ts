...
import { UpdateSummary } from "@pulumi/azure-native/azurestackhci/v20240901preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(UpdateSummary, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure UpdateSummary shouldn't use an unstable API (azurestackhci.v20240901preview.UpdateSummary). A compatible replacement can be found at 'azurestackhci.UpdateSummary'."
            );
        }),
    },
    vendors: ["azure"],
