...
import { AzureBareMetalStorageInstance } from "@pulumi/azure-native/baremetalinfrastructure/v20231101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (baremetalinfrastructure.v20231101preview.AzureBareMetalStorageInstance).
 *
 * @severity medium
 * @frameworks none
