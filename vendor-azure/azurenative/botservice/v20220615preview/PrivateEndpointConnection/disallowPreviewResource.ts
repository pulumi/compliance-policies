...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(PrivateEndpointConnection, (_, args, reportViolation) => {
            reportViolation("Azure PrivateEndpointConnection shouldn't use an unstable API (botservice.v20220615preview.PrivateEndpointConnection). A compatible replacement can be found at 'botservice.PrivateEndpointConnection'.");
        }),
    },
    vendors: ["azure"],
    services: ["botservice"],
