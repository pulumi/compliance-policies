...
import { TunnelPolicy } from "@pulumi/azure-native/cdn/v20240601preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (cdn.v20240601preview.TunnelPolicy).
 *
 * @severity medium
 * @frameworks none
