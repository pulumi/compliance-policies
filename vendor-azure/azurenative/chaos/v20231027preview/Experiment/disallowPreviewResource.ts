...
import { Experiment } from "@pulumi/azure-native/chaos/v20231027preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (chaos.v20231027preview.Experiment).
 *
 * @severity medium
 * @frameworks none
