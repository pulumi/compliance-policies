...
import { PrivateAccess } from "@pulumi/azure-native/chaos/v20231027preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (chaos.v20231027preview.PrivateAccess).
 *
 * @severity medium
 * @frameworks none
