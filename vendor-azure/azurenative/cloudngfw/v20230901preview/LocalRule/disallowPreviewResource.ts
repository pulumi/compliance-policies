...
import { LocalRule } from "@pulumi/azure-native/cloudngfw/v20230901preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (cloudngfw.v20230901preview.LocalRule).
 *
 * @severity medium
 * @frameworks none
