...
import { LocalRulestack } from "@pulumi/azure-native/cloudngfw/v20231010preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (cloudngfw.v20231010preview.LocalRulestack).
 *
 * @severity medium
 * @frameworks none
