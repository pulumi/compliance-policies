...
import { PostRule } from "@pulumi/azure-native/cloudngfw/v20231010preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (cloudngfw.v20231010preview.PostRule).
 *
 * @severity medium
 * @frameworks none
