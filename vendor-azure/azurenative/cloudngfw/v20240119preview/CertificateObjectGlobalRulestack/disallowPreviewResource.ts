...
import { CertificateObjectGlobalRulestack } from "@pulumi/azure-native/cloudngfw/v20240119preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (cloudngfw.v20240119preview.CertificateObjectGlobalRulestack).
 *
 * @severity medium
 * @frameworks none
