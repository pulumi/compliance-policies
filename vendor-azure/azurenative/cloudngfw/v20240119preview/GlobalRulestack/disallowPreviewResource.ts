...
import { GlobalRulestack } from "@pulumi/azure-native/cloudngfw/v20240119preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (cloudngfw.v20240119preview.GlobalRulestack).
 *
 * @severity medium
 * @frameworks none
