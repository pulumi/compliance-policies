...
import { RaiBlocklist } from "@pulumi/azure-native/cognitiveservices/v20240401preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(RaiBlocklist, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure RaiBlocklist shouldn't use an unstable API (cognitiveservices.v20240401preview.RaiBlocklist). A compatible replacement can be found at 'cognitiveservices.RaiBlocklist'."
            );
        }),
    },
    vendors: ["azure"],
