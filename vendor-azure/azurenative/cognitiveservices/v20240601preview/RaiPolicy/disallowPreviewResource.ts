...
import { RaiPolicy } from "@pulumi/azure-native/cognitiveservices/v20240601preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (cognitiveservices.v20240601preview.RaiPolicy).
 *
 * @severity medium
 * @frameworks none
