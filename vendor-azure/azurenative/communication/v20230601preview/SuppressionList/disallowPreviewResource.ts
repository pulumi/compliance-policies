...
import { SuppressionList } from "@pulumi/azure-native/communication/v20230601preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (communication.v20230601preview.SuppressionList).
 *
 * @severity medium
 * @frameworks none
