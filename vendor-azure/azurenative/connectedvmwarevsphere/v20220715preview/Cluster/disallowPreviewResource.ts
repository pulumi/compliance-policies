...
import { Cluster } from "@pulumi/azure-native/connectedvmwarevsphere/v20220715preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(Cluster, (_, args, reportViolation) => {
            reportViolation(
                "Azure Cluster shouldn't use an unstable API (connectedvmwarevsphere.v20220715preview.Cluster). A compatible replacement can be found at 'connectedvmwarevsphere.Cluster'."
            );
        }),
    },
    vendors: ["azure"],
