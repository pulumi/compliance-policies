...
import { Datastore } from "@pulumi/azure-native/connectedvmwarevsphere/v20220715preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(Datastore, (_, args, reportViolation) => {
            reportViolation(
                "Azure Datastore shouldn't use an unstable API (connectedvmwarevsphere.v20220715preview.Datastore). A compatible replacement can be found at 'connectedvmwarevsphere.Datastore'."
            );
        }),
    },
    vendors: ["azure"],
