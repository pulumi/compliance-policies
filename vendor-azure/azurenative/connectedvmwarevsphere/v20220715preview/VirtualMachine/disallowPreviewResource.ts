...
import { VirtualMachine } from "@pulumi/azure-native/connectedvmwarevsphere/v20220715preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(VirtualMachine, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure VirtualMachine shouldn't use an unstable API (connectedvmwarevsphere.v20220715preview.VirtualMachine). A compatible replacement can be found at 'connectedvmwarevsphere.VirtualMachine'."
            );
        }),
    },
    vendors: ["azure"],
