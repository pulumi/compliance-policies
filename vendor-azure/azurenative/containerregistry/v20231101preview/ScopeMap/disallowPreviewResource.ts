...
import { ScopeMap } from "@pulumi/azure-native/containerregistry/v20231101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (containerregistry.v20231101preview.ScopeMap).
 *
 * @severity medium
 * @frameworks none
