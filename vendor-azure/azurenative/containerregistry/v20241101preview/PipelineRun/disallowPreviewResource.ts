...
import { PipelineRun } from "@pulumi/azure-native/containerregistry/v20241101preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(PipelineRun, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure PipelineRun shouldn't use an unstable API (containerregistry.v20241101preview.PipelineRun). A compatible replacement can be found at 'containerregistry.PipelineRun'."
            );
        }),
    },
    vendors: ["azure"],
