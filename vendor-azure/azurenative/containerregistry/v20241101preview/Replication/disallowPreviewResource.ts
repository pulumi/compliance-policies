...
import { Replication } from "@pulumi/azure-native/containerregistry/v20241101preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(Replication, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure Replication shouldn't use an unstable API (containerregistry.v20241101preview.Replication). A compatible replacement can be found at 'containerregistry.Replication'."
            );
        }),
    },
    vendors: ["azure"],
