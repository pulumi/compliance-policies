...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (containerservice.v20151101preview.ContainerService).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-containerservice-v20151101preview-containerservice-disallow-preview-resource",
