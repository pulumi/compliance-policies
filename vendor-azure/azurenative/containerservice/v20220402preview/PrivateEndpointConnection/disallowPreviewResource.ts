...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (containerservice.v20220402preview.PrivateEndpointConnection).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-containerservice-v20220402preview-privateendpointconnection-disallow-preview-resource",
