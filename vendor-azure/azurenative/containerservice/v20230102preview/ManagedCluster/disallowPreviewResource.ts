...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (containerservice.v20230102preview.ManagedCluster).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-containerservice-v20230102preview-managedcluster-disallow-preview-resource",
