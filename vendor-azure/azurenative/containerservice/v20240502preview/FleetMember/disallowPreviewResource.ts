...
import { FleetMember } from "@pulumi/azure-native/containerservice/v20240502preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(FleetMember, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure FleetMember shouldn't use an unstable API (containerservice.v20240502preview.FleetMember). A compatible replacement can be found at 'containerservice.FleetMember'."
            );
        }),
    },
    vendors: ["azure"],
