...
import { LoadBalancer } from "@pulumi/azure-native/containerservice/v20240502preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(LoadBalancer, (_, args, reportViolation) => {
            reportViolation(
                "Azure LoadBalancer shouldn't use an unstable API (containerservice.v20240502preview.LoadBalancer). A compatible replacement can be found at 'containerservice.LoadBalancer'."
            );
        }),
    },
    vendors: ["azure"],
