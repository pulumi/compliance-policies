...
import { Employee } from "@pulumi/azure-native/contoso/v20211001preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (contoso.v20211001preview.Employee).
 *
 * @severity medium
 * @frameworks none
