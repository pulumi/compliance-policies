...
import { ManagedPrivateEndpoint } from "@pulumi/azure-native/dashboard/v20221001preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (dashboard.v20221001preview.ManagedPrivateEndpoint).
 *
 * @severity medium
 * @frameworks none
