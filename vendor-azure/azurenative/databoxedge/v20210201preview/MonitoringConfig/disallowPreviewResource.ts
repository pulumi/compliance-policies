...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (databoxedge.v20210201preview.MonitoringConfig).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-databoxedge-v20210201preview-monitoringconfig-disallow-preview-resource",
