...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (databoxedge.v20220401preview.BandwidthSchedule).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-databoxedge-v20220401preview-bandwidthschedule-disallow-preview-resource",
