...
import { BandwidthSchedule } from "@pulumi/azure-native/databoxedge/v20230101preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(BandwidthSchedule, (_, args, reportViolation) => {
            reportViolation("Azure BandwidthSchedule shouldn't use an unstable API (databoxedge.v20230101preview.BandwidthSchedule). A compatible replacement can be found at 'databoxedge.BandwidthSchedule'.");
        }),
    },
    vendors: ["azure"],
