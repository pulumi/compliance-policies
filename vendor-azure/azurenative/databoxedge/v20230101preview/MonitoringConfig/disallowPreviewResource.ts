...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(MonitoringConfig, (_, args, reportViolation) => {
            reportViolation("Azure MonitoringConfig shouldn't use an unstable API (databoxedge.v20230101preview.MonitoringConfig). A compatible replacement can be found at 'databoxedge.MonitoringConfig'.");
        }),
    },
    vendors: ["azure"],
