...
import { VNetPeering } from "@pulumi/azure-native/databricks/v20230915preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (databricks.v20230915preview.VNetPeering).
 *
 * @severity medium
 * @frameworks none
