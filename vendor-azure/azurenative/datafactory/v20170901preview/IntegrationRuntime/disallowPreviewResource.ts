...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (datafactory.v20170901preview.IntegrationRuntime).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-datafactory-v20170901preview-integrationruntime-disallow-preview-resource",
