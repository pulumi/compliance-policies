...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (datamigration.v20211030preview.ServiceTask).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-datamigration-v20211030preview-servicetask-disallow-preview-resource",
