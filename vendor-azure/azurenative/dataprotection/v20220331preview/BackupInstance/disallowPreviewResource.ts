...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (dataprotection.v20220331preview.BackupInstance).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-dataprotection-v20220331preview-backupinstance-disallow-preview-resource",
