...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(DppResourceGuardProxy, (_, args, reportViolation) => {
            reportViolation("Azure DppResourceGuardProxy shouldn't use an unstable API (dataprotection.v20221101preview.DppResourceGuardProxy). A compatible replacement can be found at 'dataprotection.v20230101.DppResourceGuardProxy'.");
        }),
    },
    vendors: ["azure"],
