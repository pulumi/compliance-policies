...
import { ResourceGuard } from "@pulumi/azure-native/dataprotection/v20230801preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (dataprotection.v20230801preview.ResourceGuard).
 *
 * @severity medium
 * @frameworks none
