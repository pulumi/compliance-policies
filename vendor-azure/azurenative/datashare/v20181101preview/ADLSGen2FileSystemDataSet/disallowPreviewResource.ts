...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (datashare.v20181101preview.ADLSGen2FileSystemDataSet).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-datashare-v20181101preview-adlsgen2filesystemdataset-disallow-preview-resource",
