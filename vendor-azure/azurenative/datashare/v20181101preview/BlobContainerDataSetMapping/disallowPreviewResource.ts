...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(BlobContainerDataSetMapping, (_, args, reportViolation) => {
            reportViolation("Azure BlobContainerDataSetMapping shouldn't use an unstable API (datashare.v20181101preview.BlobContainerDataSetMapping). A compatible replacement can be found at 'datashare.BlobContainerDataSetMapping'.");
        }),
    },
    vendors: ["azure"],
    services: ["datashare"],
