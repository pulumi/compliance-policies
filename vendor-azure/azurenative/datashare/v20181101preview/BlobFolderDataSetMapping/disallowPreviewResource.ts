...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(BlobFolderDataSetMapping, (_, args, reportViolation) => {
            reportViolation("Azure BlobFolderDataSetMapping shouldn't use an unstable API (datashare.v20181101preview.BlobFolderDataSetMapping). A compatible replacement can be found at 'datashare.BlobFolderDataSetMapping'.");
        }),
    },
    vendors: ["azure"],
    services: ["datashare"],
