...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (datashare.v20181101preview.SqlDWTableDataSetMapping).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-datashare-v20181101preview-sqldwtabledatasetmapping-disallow-preview-resource",
