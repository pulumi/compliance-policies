...
/**
 * Disallow the use of non-stable (Preview) Azure resouces (datashare.v20201001preview.BlobContainerDataSet).
 *
 * @severity medium
 * @frameworks none
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        name: "azurenative-datashare-v20201001preview-blobcontainerdataset-disallow-preview-resource",
