...
import { Server } from "@pulumi/azure-native/dbforpostgresql/v20240301preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (dbforpostgresql.v20240301preview.Server).
 *
 * @severity medium
 * @frameworks none
