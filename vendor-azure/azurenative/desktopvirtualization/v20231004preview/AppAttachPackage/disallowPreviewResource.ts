...
import { AppAttachPackage } from "@pulumi/azure-native/desktopvirtualization/v20231004preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (desktopvirtualization.v20231004preview.AppAttachPackage).
 *
 * @severity medium
 * @frameworks none
