...
import { ScalingPlanPersonalSchedule } from "@pulumi/azure-native/desktopvirtualization/v20240306preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (desktopvirtualization.v20240306preview.ScalingPlanPersonalSchedule).
 *
 * @severity medium
 * @frameworks none
