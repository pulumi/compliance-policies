...
import { DevBoxDefinition } from "@pulumi/azure-native/devcenter/v20230801preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(DevBoxDefinition, (_, args, reportViolation) => {
            reportViolation(
                "Azure DevBoxDefinition shouldn't use an unstable API (devcenter.v20230801preview.DevBoxDefinition). A compatible replacement can be found at 'devcenter.DevBoxDefinition'."
            );
        }),
    },
    vendors: ["azure"],
