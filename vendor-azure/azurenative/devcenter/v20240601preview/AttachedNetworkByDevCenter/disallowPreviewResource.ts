...
import { AttachedNetworkByDevCenter } from "@pulumi/azure-native/devcenter/v20240601preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (devcenter.v20240601preview.AttachedNetworkByDevCenter).
 *
 * @severity medium
 * @frameworks none
