...
import { DevBoxDefinition } from "@pulumi/azure-native/devcenter/v20240801preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (devcenter.v20240801preview.DevBoxDefinition).
 *
 * @severity medium
 * @frameworks none
