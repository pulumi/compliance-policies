...
import { IacProfile } from "@pulumi/azure-native/devhub/v20240801preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (devhub.v20240801preview.IacProfile).
 *
 * @severity medium
 * @frameworks none
