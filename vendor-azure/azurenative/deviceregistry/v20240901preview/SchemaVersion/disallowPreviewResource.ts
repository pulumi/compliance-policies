...
import { SchemaVersion } from "@pulumi/azure-native/deviceregistry/v20240901preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (deviceregistry.v20240901preview.SchemaVersion).
 *
 * @severity medium
 * @frameworks none
