...
import { Pool } from "@pulumi/azure-native/devopsinfrastructure/v20240404preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (devopsinfrastructure.v20240404preview.Pool).
 *
 * @severity medium
 * @frameworks none
