...
import { MongoDBResourceMongoRoleDefinition } from "@pulumi/azure-native/documentdb/v20231115preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (documentdb.v20231115preview.MongoDBResourceMongoRoleDefinition).
 *
 * @severity medium
 * @frameworks none
