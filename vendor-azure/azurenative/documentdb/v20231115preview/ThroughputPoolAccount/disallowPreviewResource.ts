...
import { ThroughputPoolAccount } from "@pulumi/azure-native/documentdb/v20231115preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (documentdb.v20231115preview.ThroughputPoolAccount).
 *
 * @severity medium
 * @frameworks none
