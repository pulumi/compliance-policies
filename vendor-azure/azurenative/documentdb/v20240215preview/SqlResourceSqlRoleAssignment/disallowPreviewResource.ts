...
import { SqlResourceSqlRoleAssignment } from "@pulumi/azure-native/documentdb/v20240215preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (documentdb.v20240215preview.SqlResourceSqlRoleAssignment).
 *
 * @severity medium
 * @frameworks none
