...
import { GremlinResourceGremlinGraph } from "@pulumi/azure-native/documentdb/v20240515preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (documentdb.v20240515preview.GremlinResourceGremlinGraph).
 *
 * @severity medium
 * @frameworks none
