...
import { NamespaceTopic } from "@pulumi/azure-native/eventgrid/v20231215preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (eventgrid.v20231215preview.NamespaceTopic).
 *
 * @severity medium
 * @frameworks none
