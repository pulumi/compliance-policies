...
import { SystemTopicEventSubscription } from "@pulumi/azure-native/eventgrid/v20240601preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (eventgrid.v20240601preview.SystemTopicEventSubscription).
 *
 * @severity medium
 * @frameworks none
