...
import { NamespaceNetworkRuleSet } from "@pulumi/azure-native/eventhub/v20240501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (eventhub.v20240501preview.NamespaceNetworkRuleSet).
 *
 * @severity medium
 * @frameworks none
