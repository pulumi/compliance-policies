...
import { Cluster } from "@pulumi/azure-native/hdinsight/v20231101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (hdinsight.v20231101preview.Cluster).
 *
 * @severity medium
 * @frameworks none
