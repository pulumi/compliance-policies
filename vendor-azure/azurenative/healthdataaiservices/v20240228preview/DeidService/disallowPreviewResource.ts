...
import { DeidService } from "@pulumi/azure-native/healthdataaiservices/v20240228preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (healthdataaiservices.v20240228preview.DeidService).
 *
 * @severity medium
 * @frameworks none
