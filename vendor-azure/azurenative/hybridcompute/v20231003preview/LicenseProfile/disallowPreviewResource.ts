...
import { LicenseProfile } from "@pulumi/azure-native/hybridcompute/v20231003preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (hybridcompute.v20231003preview.LicenseProfile).
 *
 * @severity medium
 * @frameworks none
