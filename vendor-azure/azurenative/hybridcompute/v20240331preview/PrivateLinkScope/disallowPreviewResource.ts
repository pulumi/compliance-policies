...
import { PrivateLinkScope } from "@pulumi/azure-native/hybridcompute/v20240331preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (hybridcompute.v20240331preview.PrivateLinkScope).
 *
 * @severity medium
 * @frameworks none
