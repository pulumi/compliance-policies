...
import { AgentPool } from "@pulumi/azure-native/hybridcontainerservice/v20220901preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(AgentPool, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure AgentPool shouldn't use an unstable API (hybridcontainerservice.v20220901preview.AgentPool). A compatible replacement can be found at 'hybridcontainerservice.AgentPool'."
            );
        }),
    },
    vendors: ["azure"],
