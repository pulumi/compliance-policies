...
import { ApplicationResource } from "@pulumi/azure-native/integrationspaces/v20231114preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (integrationspaces.v20231114preview.ApplicationResource).
 *
 * @severity medium
 * @frameworks none
