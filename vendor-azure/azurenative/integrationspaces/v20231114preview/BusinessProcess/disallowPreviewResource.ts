...
import { BusinessProcess } from "@pulumi/azure-native/integrationspaces/v20231114preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (integrationspaces.v20231114preview.BusinessProcess).
 *
 * @severity medium
 * @frameworks none
