...
import { BrokerListener } from "@pulumi/azure-native/iotoperations/v20240701preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(BrokerListener, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure BrokerListener shouldn't use an unstable API (iotoperations.v20240701preview.BrokerListener). A compatible replacement can be found at 'iotoperations.BrokerListener'."
            );
        }),
    },
    vendors: ["azure"],
