...
import { DataFlowProfile } from "@pulumi/azure-native/iotoperations/v20240701preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(DataFlowProfile, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure DataFlowProfile shouldn't use an unstable API (iotoperations.v20240701preview.DataFlowProfile). A compatible replacement can be found at 'iotoperations.DataFlowProfile'."
            );
        }),
    },
    vendors: ["azure"],
