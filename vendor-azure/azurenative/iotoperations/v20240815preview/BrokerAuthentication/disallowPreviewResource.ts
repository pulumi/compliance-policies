...
import { BrokerAuthentication } from "@pulumi/azure-native/iotoperations/v20240815preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (iotoperations.v20240815preview.BrokerAuthentication).
 *
 * @severity medium
 * @frameworks none
