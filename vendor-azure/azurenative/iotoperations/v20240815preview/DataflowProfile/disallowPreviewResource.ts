...
import { DataflowProfile } from "@pulumi/azure-native/iotoperations/v20240815preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (iotoperations.v20240815preview.DataflowProfile).
 *
 * @severity medium
 * @frameworks none
