...
import { Dataset } from "@pulumi/azure-native/iotoperationsdataprocessor/v20231004preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (iotoperationsdataprocessor.v20231004preview.Dataset).
 *
 * @severity medium
 * @frameworks none
