...
import { BrokerListener } from "@pulumi/azure-native/iotoperationsmq/v20231004preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (iotoperationsmq.v20231004preview.BrokerListener).
 *
 * @severity medium
 * @frameworks none
