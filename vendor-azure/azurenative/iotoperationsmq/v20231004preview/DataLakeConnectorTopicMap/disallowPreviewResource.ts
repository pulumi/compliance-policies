...
import { DataLakeConnectorTopicMap } from "@pulumi/azure-native/iotoperationsmq/v20231004preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (iotoperationsmq.v20231004preview.DataLakeConnectorTopicMap).
 *
 * @severity medium
 * @frameworks none
