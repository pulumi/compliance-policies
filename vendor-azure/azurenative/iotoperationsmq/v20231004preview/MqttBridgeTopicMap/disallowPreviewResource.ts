...
import { MqttBridgeTopicMap } from "@pulumi/azure-native/iotoperationsmq/v20231004preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (iotoperationsmq.v20231004preview.MqttBridgeTopicMap).
 *
 * @severity medium
 * @frameworks none
