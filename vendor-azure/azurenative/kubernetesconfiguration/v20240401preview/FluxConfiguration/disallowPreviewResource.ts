...
import { FluxConfiguration } from "@pulumi/azure-native/kubernetesconfiguration/v20240401preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (kubernetesconfiguration.v20240401preview.FluxConfiguration).
 *
 * @severity medium
 * @frameworks none
