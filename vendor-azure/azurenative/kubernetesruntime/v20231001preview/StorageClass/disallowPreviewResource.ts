...
import { StorageClass } from "@pulumi/azure-native/kubernetesruntime/v20231001preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (kubernetesruntime.v20231001preview.StorageClass).
 *
 * @severity medium
 * @frameworks none
