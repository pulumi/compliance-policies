...
import { LoadTestMapping } from "@pulumi/azure-native/loadtestservice/v20231201preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (loadtestservice.v20231201preview.LoadTestMapping).
 *
 * @severity medium
 * @frameworks none
