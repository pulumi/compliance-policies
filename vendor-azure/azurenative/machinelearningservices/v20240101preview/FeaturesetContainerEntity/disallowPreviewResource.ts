...
import { FeaturesetContainerEntity } from "@pulumi/azure-native/machinelearningservices/v20240101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (machinelearningservices.v20240101preview.FeaturesetContainerEntity).
 *
 * @severity medium
 * @frameworks none
