...
import { ConnectionRaiBlocklist } from "@pulumi/azure-native/machinelearningservices/v20240701preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (machinelearningservices.v20240701preview.ConnectionRaiBlocklist).
 *
 * @severity medium
 * @frameworks none
