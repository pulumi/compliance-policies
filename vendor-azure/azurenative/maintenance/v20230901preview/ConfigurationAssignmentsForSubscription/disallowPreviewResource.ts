...
import { ConfigurationAssignmentsForSubscription } from "@pulumi/azure-native/maintenance/v20230901preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (maintenance.v20230901preview.ConfigurationAssignmentsForSubscription).
 *
 * @severity medium
 * @frameworks none
