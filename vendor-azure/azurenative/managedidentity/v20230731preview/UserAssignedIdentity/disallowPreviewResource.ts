...
import { UserAssignedIdentity } from "@pulumi/azure-native/managedidentity/v20230731preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (managedidentity.v20230731preview.UserAssignedIdentity).
 *
 * @severity medium
 * @frameworks none
