...
import { AvsAssessmentsOperation } from "@pulumi/azure-native/migrate/v20230401preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (migrate.v20230401preview.AvsAssessmentsOperation).
 *
 * @severity medium
 * @frameworks none
