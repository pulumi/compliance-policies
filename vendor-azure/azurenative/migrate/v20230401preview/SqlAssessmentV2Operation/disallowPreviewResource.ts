...
import { SqlAssessmentV2Operation } from "@pulumi/azure-native/migrate/v20230401preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (migrate.v20230401preview.SqlAssessmentV2Operation).
 *
 * @severity medium
 * @frameworks none
