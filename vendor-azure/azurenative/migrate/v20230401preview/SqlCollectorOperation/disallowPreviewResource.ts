...
import { SqlCollectorOperation } from "@pulumi/azure-native/migrate/v20230401preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (migrate.v20230401preview.SqlCollectorOperation).
 *
 * @severity medium
 * @frameworks none
