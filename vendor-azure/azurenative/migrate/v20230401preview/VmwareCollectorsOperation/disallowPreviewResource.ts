...
import { VmwareCollectorsOperation } from "@pulumi/azure-native/migrate/v20230401preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (migrate.v20230401preview.VmwareCollectorsOperation).
 *
 * @severity medium
 * @frameworks none
