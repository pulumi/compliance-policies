...
import { NrfDeployment } from "@pulumi/azure-native/mobilepacketcore/v20231015preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (mobilepacketcore.v20231015preview.NrfDeployment).
 *
 * @severity medium
 * @frameworks none
