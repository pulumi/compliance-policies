...
import { PipelineGroup } from "@pulumi/azure-native/monitor/v20231001preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (monitor.v20231001preview.PipelineGroup).
 *
 * @severity medium
 * @frameworks none
