...
import { VolumeGroup } from "@pulumi/azure-native/netapp/v20230501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (netapp.v20230501preview.VolumeGroup).
 *
 * @severity medium
 * @frameworks none
