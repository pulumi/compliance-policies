...
import { VolumeQuotaRule } from "@pulumi/azure-native/netapp/v20240301preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (netapp.v20240301preview.VolumeQuotaRule).
 *
 * @severity medium
 * @frameworks none
