...
import { UserRuleCollection } from "@pulumi/azure-native/network/v20210201preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(UserRuleCollection, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure UserRuleCollection shouldn't use an unstable API (network.v20210201preview.UserRuleCollection). A compatible replacement can be found at 'network.UserRuleCollection'."
            );
        }),
    },
    vendors: ["azure"],
