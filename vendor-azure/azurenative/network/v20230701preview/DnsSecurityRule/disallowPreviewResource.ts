...
import { DnsSecurityRule } from "@pulumi/azure-native/network/v20230701preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(DnsSecurityRule, (_, args, reportViolation) => {
