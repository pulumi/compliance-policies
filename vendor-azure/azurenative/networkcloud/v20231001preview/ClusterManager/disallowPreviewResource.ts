...
import { ClusterManager } from "@pulumi/azure-native/networkcloud/v20231001preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(ClusterManager, (_, args, reportViolation) => {
            reportViolation(
                "Azure ClusterManager shouldn't use an unstable API (networkcloud.v20231001preview.ClusterManager). A compatible replacement can be found at 'networkcloud.ClusterManager'."
            );
        }),
    },
    vendors: ["azure"],
