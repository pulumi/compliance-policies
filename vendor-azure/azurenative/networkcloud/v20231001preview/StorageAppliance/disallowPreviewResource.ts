...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(StorageAppliance, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure StorageAppliance shouldn't use an unstable API (networkcloud.v20231001preview.StorageAppliance). A compatible replacement can be found at 'networkcloud.StorageAppliance'."
            );
        }),
    },
    vendors: ["azure"],
