...
import { BareMetalMachine } from "@pulumi/azure-native/networkcloud/v20240601preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (networkcloud.v20240601preview.BareMetalMachine).
 *
 * @severity medium
 * @frameworks none
