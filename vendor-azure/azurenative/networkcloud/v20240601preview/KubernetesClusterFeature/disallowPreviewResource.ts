...
import { KubernetesClusterFeature } from "@pulumi/azure-native/networkcloud/v20240601preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (networkcloud.v20240601preview.KubernetesClusterFeature).
 *
 * @severity medium
 * @frameworks none
