...
import { MasterSitesController } from "@pulumi/azure-native/offazure/v20231001preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (offazure.v20231001preview.MasterSitesController).
 *
 * @severity medium
 * @frameworks none
