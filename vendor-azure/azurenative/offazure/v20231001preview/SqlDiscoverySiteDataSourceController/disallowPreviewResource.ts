...
import { SqlDiscoverySiteDataSourceController } from "@pulumi/azure-native/offazure/v20231001preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (offazure.v20231001preview.SqlDiscoverySiteDataSourceController).
 *
 * @severity medium
 * @frameworks none
