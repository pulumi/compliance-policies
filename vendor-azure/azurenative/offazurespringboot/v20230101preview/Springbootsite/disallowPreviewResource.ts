...
import { Springbootsite } from "@pulumi/azure-native/offazurespringboot/v20230101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (offazurespringboot.v20230101preview.Springbootsite).
 *
 * @severity medium
 * @frameworks none
