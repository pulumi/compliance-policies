...
import { Dashboard } from "@pulumi/azure-native/portal/v20221201preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (portal.v20221201preview.Dashboard).
 *
 * @severity medium
 * @frameworks none
