...
import { OperatorApiConnection } from "@pulumi/azure-native/programmableconnectivity/v20240115preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (programmableconnectivity.v20240115preview.OperatorApiConnection).
 *
 * @severity medium
 * @frameworks none
