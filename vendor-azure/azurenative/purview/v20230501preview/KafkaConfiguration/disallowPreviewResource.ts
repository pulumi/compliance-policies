...
import { KafkaConfiguration } from "@pulumi/azure-native/purview/v20230501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (purview.v20230501preview.KafkaConfiguration).
 *
 * @severity medium
 * @frameworks none
