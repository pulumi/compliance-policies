...
import { ProtectedItem } from "@pulumi/azure-native/recoveryservices/v20240430preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (recoveryservices.v20240430preview.ProtectedItem).
 *
 * @severity medium
 * @frameworks none
