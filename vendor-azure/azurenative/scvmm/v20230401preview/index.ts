...
export * as AvailabilitySet from "./AvailabilitySet";
export * as Cloud from "./Cloud";
export * as GuestAgent from "./GuestAgent";
export * as HybridIdentityMetadata from "./HybridIdentityMetadata";
export * as InventoryItem from "./InventoryItem";
export * as MachineExtension from "./MachineExtension";
export * as VMInstanceGuestAgent from "./VMInstanceGuestAgent";
...
export * as VmmServer from "./VmmServer";
