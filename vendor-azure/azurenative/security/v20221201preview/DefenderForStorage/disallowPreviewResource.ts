...
import { DefenderForStorage } from "@pulumi/azure-native/security/v20221201preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (security.v20221201preview.DefenderForStorage).
 *
 * @severity medium
 * @frameworks none
