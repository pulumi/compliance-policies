...
import { DevOpsPolicyAssignment } from "@pulumi/azure-native/security/v20240515preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (security.v20240515preview.DevOpsPolicyAssignment).
 *
 * @severity medium
 * @frameworks none
