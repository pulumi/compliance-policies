...
import { AnomalySecurityMLAnalyticsSettings } from "@pulumi/azure-native/securityinsights/v20231001preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (securityinsights.v20231001preview.AnomalySecurityMLAnalyticsSettings).
 *
 * @severity medium
 * @frameworks none
