...
import { MLBehaviorAnalyticsAlertRule } from "@pulumi/azure-native/securityinsights/v20231201preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (securityinsights.v20231201preview.MLBehaviorAnalyticsAlertRule).
 *
 * @severity medium
 * @frameworks none
