...
import { WatchlistItem } from "@pulumi/azure-native/securityinsights/v20231201preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (securityinsights.v20231201preview.WatchlistItem).
 *
 * @severity medium
 * @frameworks none
