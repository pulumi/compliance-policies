...
import { CodelessApiPollingDataConnector } from "@pulumi/azure-native/securityinsights/v20240101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (securityinsights.v20240101preview.CodelessApiPollingDataConnector).
 *
 * @severity medium
 * @frameworks none
