...
import { ManagedClusterApplicationTypeVersion } from "@pulumi/azure-native/servicefabric/v20230901preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (servicefabric.v20230901preview.ManagedClusterApplicationTypeVersion).
 *
 * @severity medium
 * @frameworks none
