...
import { NodeType } from "@pulumi/azure-native/servicefabric/v20231201preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (servicefabric.v20231201preview.NodeType).
 *
 * @severity medium
 * @frameworks none
