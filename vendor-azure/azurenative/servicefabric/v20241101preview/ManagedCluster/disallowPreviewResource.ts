...
import { ManagedCluster } from "@pulumi/azure-native/servicefabric/v20241101preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(ManagedCluster, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure ManagedCluster shouldn't use an unstable API (servicefabric.v20241101preview.ManagedCluster). A compatible replacement can be found at 'servicefabric.ManagedCluster'."
            );
        }),
    },
    vendors: ["azure"],
