...
import { Connector } from "@pulumi/azure-native/servicelinker/v20230401preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (servicelinker.v20230401preview.Connector).
 *
 * @severity medium
 * @frameworks none
