...
import { SignalRCustomCertificate } from "@pulumi/azure-native/signalrservice/v20240101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (signalrservice.v20240101preview.SignalRCustomCertificate).
 *
 * @severity medium
 * @frameworks none
