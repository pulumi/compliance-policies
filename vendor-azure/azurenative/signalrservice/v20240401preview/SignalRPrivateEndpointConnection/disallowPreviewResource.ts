...
import { SignalRPrivateEndpointConnection } from "@pulumi/azure-native/signalrservice/v20240401preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (signalrservice.v20240401preview.SignalRPrivateEndpointConnection).
 *
 * @severity medium
 * @frameworks none
