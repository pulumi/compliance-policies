...
import { OutboundFirewallRule } from "@pulumi/azure-native/sql/v20230201preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(OutboundFirewallRule, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure OutboundFirewallRule shouldn't use an unstable API (sql.v20230201preview.OutboundFirewallRule). A compatible replacement can be found at 'sql.OutboundFirewallRule'."
            );
        }),
    },
    vendors: ["azure"],
