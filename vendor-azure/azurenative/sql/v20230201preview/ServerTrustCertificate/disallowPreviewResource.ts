...
import { ServerTrustCertificate } from "@pulumi/azure-native/sql/v20230201preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(ServerTrustCertificate, (_, args, reportViolation) => {
            ...
            reportViolation(
                "Azure ServerTrustCertificate shouldn't use an unstable API (sql.v20230201preview.ServerTrustCertificate). A compatible replacement can be found at 'sql.ServerTrustCertificate'."
            );
        }),
    },
    vendors: ["azure"],
