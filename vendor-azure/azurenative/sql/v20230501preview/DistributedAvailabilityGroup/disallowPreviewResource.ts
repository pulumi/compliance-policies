...
import { DistributedAvailabilityGroup } from "@pulumi/azure-native/sql/v20230501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (sql.v20230501preview.DistributedAvailabilityGroup).
 *
 * @severity medium
 * @frameworks none
