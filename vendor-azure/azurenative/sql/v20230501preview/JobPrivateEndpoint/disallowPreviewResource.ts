...
import { JobPrivateEndpoint } from "@pulumi/azure-native/sql/v20230501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (sql.v20230501preview.JobPrivateEndpoint).
 *
 * @severity medium
 * @frameworks none
