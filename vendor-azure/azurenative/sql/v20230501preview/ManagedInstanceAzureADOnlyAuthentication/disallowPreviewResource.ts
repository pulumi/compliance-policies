...
import { ManagedInstanceAzureADOnlyAuthentication } from "@pulumi/azure-native/sql/v20230501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (sql.v20230501preview.ManagedInstanceAzureADOnlyAuthentication).
 *
 * @severity medium
 * @frameworks none
