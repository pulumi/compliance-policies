...
import { ManagedInstancePrivateEndpointConnection } from "@pulumi/azure-native/sql/v20230801preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (sql.v20230801preview.ManagedInstancePrivateEndpointConnection).
 *
 * @severity medium
 * @frameworks none
