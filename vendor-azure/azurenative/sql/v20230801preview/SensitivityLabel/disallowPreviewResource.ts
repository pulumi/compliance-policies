...
import { SensitivityLabel } from "@pulumi/azure-native/sql/v20230801preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (sql.v20230801preview.SensitivityLabel).
 *
 * @severity medium
 * @frameworks none
