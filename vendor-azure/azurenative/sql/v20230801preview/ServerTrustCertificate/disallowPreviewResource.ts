...
import { ServerTrustCertificate } from "@pulumi/azure-native/sql/v20230801preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (sql.v20230801preview.ServerTrustCertificate).
 *
 * @severity medium
 * @frameworks none
