...
import { IPv6FirewallRule } from "@pulumi/azure-native/sql/v20240501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (sql.v20240501preview.IPv6FirewallRule).
 *
 * @severity medium
 * @frameworks none
