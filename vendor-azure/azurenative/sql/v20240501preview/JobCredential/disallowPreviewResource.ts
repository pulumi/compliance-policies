...
import { JobCredential } from "@pulumi/azure-native/sql/v20240501preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (sql.v20240501preview.JobCredential).
 *
 * @severity medium
 * @frameworks none
