...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.storagepool.v20200315preview.IscsiTarget, (_, args, reportViolation) => {
            reportViolation("Azure IscsiTarget shouldn't use an unstable API (storagepool.v20200315preview.IscsiTarget).");
        }),
    },
    vendors: ["azure"],
