...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.streamanalytics.v20170401preview.StreamingJob, (_, args, reportViolation) => {
            reportViolation("Azure StreamingJob shouldn't use an unstable API (streamanalytics.v20170401preview.StreamingJob).");
        }),
    },
    vendors: ["azure"],
