...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.streamanalytics.v20200301preview.PrivateEndpoint, (_, args, reportViolation) => {
            reportViolation("Azure PrivateEndpoint shouldn't use an unstable API (streamanalytics.v20200301preview.PrivateEndpoint).");
        }),
    },
    vendors: ["azure"],
