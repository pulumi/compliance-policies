...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.streamanalytics.v20211001preview.Function, (_, args, reportViolation) => {
            reportViolation("Azure Function shouldn't use an unstable API (streamanalytics.v20211001preview.Function).");
        }),
    },
    vendors: ["azure"],
