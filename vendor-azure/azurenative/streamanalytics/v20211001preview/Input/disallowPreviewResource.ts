...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.streamanalytics.v20211001preview.Input, (_, args, reportViolation) => {
            reportViolation("Azure Input shouldn't use an unstable API (streamanalytics.v20211001preview.Input).");
        }),
    },
    vendors: ["azure"],
