...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.streamanalytics.v20211001preview.StreamingJob, (_, args, reportViolation) => {
            reportViolation("Azure StreamingJob shouldn't use an unstable API (streamanalytics.v20211001preview.StreamingJob).");
        }),
    },
    vendors: ["azure"],
