...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210401preview.DatabasePrincipalAssignment, (_, args, reportViolation) => {
            reportViolation("Azure DatabasePrincipalAssignment shouldn't use an unstable API (synapse.v20210401preview.DatabasePrincipalAssignment).");
        }),
    },
    vendors: ["azure"],
