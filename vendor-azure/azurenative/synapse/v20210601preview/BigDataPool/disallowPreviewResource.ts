...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.BigDataPool, (_, args, reportViolation) => {
            reportViolation("Azure BigDataPool shouldn't use an unstable API (synapse.v20210601preview.BigDataPool).");
        }),
    },
    vendors: ["azure"],
