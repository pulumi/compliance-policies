...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.EventGridDataConnection, (_, args, reportViolation) => {
            reportViolation("Azure EventGridDataConnection shouldn't use an unstable API (synapse.v20210601preview.EventGridDataConnection).");
        }),
    },
    vendors: ["azure"],
