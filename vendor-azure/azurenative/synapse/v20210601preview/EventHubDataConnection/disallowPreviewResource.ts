...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.EventHubDataConnection, (_, args, reportViolation) => {
            reportViolation("Azure EventHubDataConnection shouldn't use an unstable API (synapse.v20210601preview.EventHubDataConnection).");
        }),
    },
    vendors: ["azure"],
