...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.IntegrationRuntime, (_, args, reportViolation) => {
            reportViolation("Azure IntegrationRuntime shouldn't use an unstable API (synapse.v20210601preview.IntegrationRuntime).");
        }),
    },
    vendors: ["azure"],
