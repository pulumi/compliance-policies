...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.IotHubDataConnection, (_, args, reportViolation) => {
            reportViolation("Azure IotHubDataConnection shouldn't use an unstable API (synapse.v20210601preview.IotHubDataConnection).");
        }),
    },
    vendors: ["azure"],
