...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.IpFirewallRule, (_, args, reportViolation) => {
            reportViolation("Azure IpFirewallRule shouldn't use an unstable API (synapse.v20210601preview.IpFirewallRule).");
        }),
    },
    vendors: ["azure"],
