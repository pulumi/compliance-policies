...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.Key, (_, args, reportViolation) => {
            reportViolation("Azure Key shouldn't use an unstable API (synapse.v20210601preview.Key).");
        }),
    },
    vendors: ["azure"],
