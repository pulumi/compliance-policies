...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.KustoPool, (_, args, reportViolation) => {
            reportViolation("Azure KustoPool shouldn't use an unstable API (synapse.v20210601preview.KustoPool).");
        }),
    },
    vendors: ["azure"],
