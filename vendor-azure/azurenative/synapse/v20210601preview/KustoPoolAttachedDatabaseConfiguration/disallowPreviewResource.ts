...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.KustoPoolAttachedDatabaseConfiguration, (_, args, reportViolation) => {
            reportViolation("Azure KustoPoolAttachedDatabaseConfiguration shouldn't use an unstable API (synapse.v20210601preview.KustoPoolAttachedDatabaseConfiguration).");
        }),
    },
    vendors: ["azure"],
