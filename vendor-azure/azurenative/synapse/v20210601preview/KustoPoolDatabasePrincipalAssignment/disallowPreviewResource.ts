...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.KustoPoolDatabasePrincipalAssignment, (_, args, reportViolation) => {
            reportViolation("Azure KustoPoolDatabasePrincipalAssignment shouldn't use an unstable API (synapse.v20210601preview.KustoPoolDatabasePrincipalAssignment).");
        }),
    },
    vendors: ["azure"],
