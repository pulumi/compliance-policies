...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.KustoPoolPrincipalAssignment, (_, args, reportViolation) => {
            reportViolation("Azure KustoPoolPrincipalAssignment shouldn't use an unstable API (synapse.v20210601preview.KustoPoolPrincipalAssignment).");
        }),
    },
    vendors: ["azure"],
