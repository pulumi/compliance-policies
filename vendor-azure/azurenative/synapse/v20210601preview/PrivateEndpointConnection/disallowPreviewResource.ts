...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.PrivateEndpointConnection, (_, args, reportViolation) => {
            reportViolation("Azure PrivateEndpointConnection shouldn't use an unstable API (synapse.v20210601preview.PrivateEndpointConnection).");
        }),
    },
    vendors: ["azure"],
