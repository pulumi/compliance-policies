...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.PrivateLinkHub, (_, args, reportViolation) => {
            reportViolation("Azure PrivateLinkHub shouldn't use an unstable API (synapse.v20210601preview.PrivateLinkHub).");
        }),
    },
    vendors: ["azure"],
