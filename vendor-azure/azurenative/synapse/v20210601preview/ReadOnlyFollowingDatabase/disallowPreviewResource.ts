...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.ReadOnlyFollowingDatabase, (_, args, reportViolation) => {
            reportViolation("Azure ReadOnlyFollowingDatabase shouldn't use an unstable API (synapse.v20210601preview.ReadOnlyFollowingDatabase).");
        }),
    },
    vendors: ["azure"],
