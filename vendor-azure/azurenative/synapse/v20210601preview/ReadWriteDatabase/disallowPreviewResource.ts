...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.ReadWriteDatabase, (_, args, reportViolation) => {
            reportViolation("Azure ReadWriteDatabase shouldn't use an unstable API (synapse.v20210601preview.ReadWriteDatabase).");
        }),
    },
    vendors: ["azure"],
