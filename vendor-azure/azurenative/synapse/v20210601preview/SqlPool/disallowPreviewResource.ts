...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.SqlPool, (_, args, reportViolation) => {
            reportViolation("Azure SqlPool shouldn't use an unstable API (synapse.v20210601preview.SqlPool).");
        }),
    },
    vendors: ["azure"],
