...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.SqlPoolSensitivityLabel, (_, args, reportViolation) => {
            reportViolation("Azure SqlPoolSensitivityLabel shouldn't use an unstable API (synapse.v20210601preview.SqlPoolSensitivityLabel).");
        }),
    },
    vendors: ["azure"],
