...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.SqlPoolTransparentDataEncryption, (_, args, reportViolation) => {
            reportViolation("Azure SqlPoolTransparentDataEncryption shouldn't use an unstable API (synapse.v20210601preview.SqlPoolTransparentDataEncryption).");
        }),
    },
    vendors: ["azure"],
