...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.SqlPoolWorkloadClassifier, (_, args, reportViolation) => {
            reportViolation("Azure SqlPoolWorkloadClassifier shouldn't use an unstable API (synapse.v20210601preview.SqlPoolWorkloadClassifier).");
        }),
    },
    vendors: ["azure"],
