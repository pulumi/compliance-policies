...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.SqlPoolWorkloadGroup, (_, args, reportViolation) => {
            reportViolation("Azure SqlPoolWorkloadGroup shouldn't use an unstable API (synapse.v20210601preview.SqlPoolWorkloadGroup).");
        }),
    },
    vendors: ["azure"],
