...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.Workspace, (_, args, reportViolation) => {
            reportViolation("Azure Workspace shouldn't use an unstable API (synapse.v20210601preview.Workspace).");
        }),
    },
    vendors: ["azure"],
