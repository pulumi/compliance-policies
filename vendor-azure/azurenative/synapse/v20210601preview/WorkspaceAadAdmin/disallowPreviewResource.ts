...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.WorkspaceAadAdmin, (_, args, reportViolation) => {
            reportViolation("Azure WorkspaceAadAdmin shouldn't use an unstable API (synapse.v20210601preview.WorkspaceAadAdmin).");
        }),
    },
    vendors: ["azure"],
