...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.synapse.v20210601preview.WorkspaceSqlAadAdmin, (_, args, reportViolation) => {
            reportViolation("Azure WorkspaceSqlAadAdmin shouldn't use an unstable API (synapse.v20210601preview.WorkspaceSqlAadAdmin).");
        }),
    },
    vendors: ["azure"],
