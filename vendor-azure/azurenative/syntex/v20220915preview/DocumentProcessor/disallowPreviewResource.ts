...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.syntex.v20220915preview.DocumentProcessor, (_, args, reportViolation) => {
            reportViolation("Azure DocumentProcessor shouldn't use an unstable API (syntex.v20220915preview.DocumentProcessor).");
        }),
    },
    vendors: ["azure"],
