...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.testbase.v20201216preview.FavoriteProcess, (_, args, reportViolation) => {
            reportViolation("Azure FavoriteProcess shouldn't use an unstable API (testbase.v20201216preview.FavoriteProcess).");
        }),
    },
    vendors: ["azure"],
