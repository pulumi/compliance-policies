...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.testbase.v20220401preview.Package, (_, args, reportViolation) => {
            reportViolation("Azure Package shouldn't use an unstable API (testbase.v20220401preview.Package).");
        }),
    },
    vendors: ["azure"],
