...
import { ActionRequest } from "@pulumi/azure-native/testbase/v20231101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (testbase.v20231101preview.ActionRequest).
 *
 * @severity medium
 * @frameworks none
