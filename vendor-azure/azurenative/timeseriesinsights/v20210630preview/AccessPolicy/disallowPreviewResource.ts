...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.timeseriesinsights.v20210630preview.AccessPolicy, (_, args, reportViolation) => {
            reportViolation("Azure AccessPolicy shouldn't use an unstable API (timeseriesinsights.v20210630preview.AccessPolicy).");
        }),
    },
    vendors: ["azure"],
