...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.timeseriesinsights.v20210630preview.EventHubEventSource, (_, args, reportViolation) => {
            reportViolation("Azure EventHubEventSource shouldn't use an unstable API (timeseriesinsights.v20210630preview.EventHubEventSource).");
        }),
    },
    vendors: ["azure"],
