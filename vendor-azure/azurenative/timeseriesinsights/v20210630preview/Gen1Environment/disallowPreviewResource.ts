...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.timeseriesinsights.v20210630preview.Gen1Environment, (_, args, reportViolation) => {
            reportViolation("Azure Gen1Environment shouldn't use an unstable API (timeseriesinsights.v20210630preview.Gen1Environment).");
        }),
    },
    vendors: ["azure"],
