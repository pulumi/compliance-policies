...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.timeseriesinsights.v20210630preview.Gen2Environment, (_, args, reportViolation) => {
            reportViolation("Azure Gen2Environment shouldn't use an unstable API (timeseriesinsights.v20210630preview.Gen2Environment).");
        }),
    },
    vendors: ["azure"],
