...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.timeseriesinsights.v20210630preview.IoTHubEventSource, (_, args, reportViolation) => {
            reportViolation("Azure IoTHubEventSource shouldn't use an unstable API (timeseriesinsights.v20210630preview.IoTHubEventSource).");
        }),
    },
    vendors: ["azure"],
