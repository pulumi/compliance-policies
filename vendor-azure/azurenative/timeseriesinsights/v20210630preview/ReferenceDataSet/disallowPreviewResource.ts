...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.timeseriesinsights.v20210630preview.ReferenceDataSet, (_, args, reportViolation) => {
            reportViolation("Azure ReferenceDataSet shouldn't use an unstable API (timeseriesinsights.v20210630preview.ReferenceDataSet).");
        }),
    },
    vendors: ["azure"],
