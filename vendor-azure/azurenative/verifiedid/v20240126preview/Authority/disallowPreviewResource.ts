...
import { Authority } from "@pulumi/azure-native/verifiedid/v20240126preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (verifiedid.v20240126preview.Authority).
 *
 * @severity medium
 * @frameworks none
