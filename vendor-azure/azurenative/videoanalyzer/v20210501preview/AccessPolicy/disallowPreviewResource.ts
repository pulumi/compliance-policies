...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.videoanalyzer.v20210501preview.AccessPolicy, (_, args, reportViolation) => {
            reportViolation("Azure AccessPolicy shouldn't use an unstable API (videoanalyzer.v20210501preview.AccessPolicy).");
        }),
    },
    vendors: ["azure"],
