...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.videoanalyzer.v20211101preview.VideoAnalyzer, (_, args, reportViolation) => {
            reportViolation("Azure VideoAnalyzer shouldn't use an unstable API (videoanalyzer.v20211101preview.VideoAnalyzer).");
        }),
    },
    vendors: ["azure"],
