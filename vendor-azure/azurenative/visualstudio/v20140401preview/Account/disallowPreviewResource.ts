...
import { Account } from "@pulumi/azure-native/visualstudio/v20140401preview";
...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(Account, (_, args, reportViolation) => {
            reportViolation("Azure Account shouldn't use an unstable API (visualstudio.v20140401preview.Account). A compatible replacement can be found at 'visualstudio.Account'.");
        }),
    },
    vendors: ["azure"],
