...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.voiceservices.v20221201preview.Contact, (_, args, reportViolation) => {
            reportViolation("Azure Contact shouldn't use an unstable API (voiceservices.v20221201preview.Contact).");
        }),
    },
    vendors: ["azure"],
