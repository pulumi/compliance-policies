...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.voiceservices.v20221201preview.TestLine, (_, args, reportViolation) => {
            reportViolation("Azure TestLine shouldn't use an unstable API (voiceservices.v20221201preview.TestLine).");
        }),
    },
    vendors: ["azure"],
