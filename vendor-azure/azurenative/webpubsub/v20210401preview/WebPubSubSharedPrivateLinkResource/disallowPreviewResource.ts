...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.webpubsub.v20210401preview.WebPubSubSharedPrivateLinkResource, (_, args, reportViolation) => {
            reportViolation("Azure WebPubSubSharedPrivateLinkResource shouldn't use an unstable API (webpubsub.v20210401preview.WebPubSubSharedPrivateLinkResource).");
        }),
    },
    vendors: ["azure"],
