...
import { WebPubSubCustomCertificate } from "@pulumi/azure-native/webpubsub/v20240101preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (webpubsub.v20240101preview.WebPubSubCustomCertificate).
 *
 * @severity medium
 * @frameworks none
