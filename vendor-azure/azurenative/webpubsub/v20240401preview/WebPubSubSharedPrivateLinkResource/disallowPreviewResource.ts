...
import { WebPubSubSharedPrivateLinkResource } from "@pulumi/azure-native/webpubsub/v20240401preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (webpubsub.v20240401preview.WebPubSubSharedPrivateLinkResource).
 *
 * @severity medium
 * @frameworks none
