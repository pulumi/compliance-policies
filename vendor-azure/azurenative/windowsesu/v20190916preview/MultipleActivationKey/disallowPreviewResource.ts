...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.windowsesu.v20190916preview.MultipleActivationKey, (_, args, reportViolation) => {
            reportViolation("Azure MultipleActivationKey shouldn't use an unstable API (windowsesu.v20190916preview.MultipleActivationKey).");
        }),
    },
    vendors: ["azure"],
