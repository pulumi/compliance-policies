...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.workloads.v20211201preview.PhpWorkload, (_, args, reportViolation) => {
            reportViolation("Azure PhpWorkload shouldn't use an unstable API (workloads.v20211201preview.PhpWorkload).");
        }),
    },
    vendors: ["azure"],
