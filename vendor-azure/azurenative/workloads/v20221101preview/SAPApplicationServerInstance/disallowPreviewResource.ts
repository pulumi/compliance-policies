...
export const disallowPreviewResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(azurenative.workloads.v20221101preview.SAPApplicationServerInstance, (_, args, reportViolation) => {
            reportViolation("Azure SAPApplicationServerInstance shouldn't use an unstable API (workloads.v20221101preview.SAPApplicationServerInstance).");
        }),
    },
    vendors: ["azure"],
