...
import { SapLandscapeMonitor } from "@pulumi/azure-native/workloads/v20231001preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (workloads.v20231001preview.SapLandscapeMonitor).
 *
 * @severity medium
 * @frameworks none
