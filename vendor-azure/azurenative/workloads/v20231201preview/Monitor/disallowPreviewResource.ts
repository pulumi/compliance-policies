...
import { Monitor } from "@pulumi/azure-native/workloads/v20231201preview";

/**
 * Disallow the use of non-stable (Preview) Azure resouces (workloads.v20231201preview.Monitor).
 *
 * @severity medium
 * @frameworks none
