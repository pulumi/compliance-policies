...
describe("azurenative.aadiam.v20200301preview.PrivateLinkForAzureAd.disallowPreviewResource", function() {
    const policy = policies.azurenative.aadiam.v20200301preview.PrivateLinkForAzureAd.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-aadiam-v20200301preview-privatelinkforazuread-disallow-preview-resource");
    });
