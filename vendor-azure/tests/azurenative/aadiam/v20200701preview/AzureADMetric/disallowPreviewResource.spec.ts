...
describe("azurenative.aadiam.v20200701preview.AzureADMetric.disallowPreviewResource", function() {
    const policy = policies.azurenative.aadiam.v20200701preview.AzureADMetric.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-aadiam-v20200701preview-azureadmetric-disallow-preview-resource");
    });
