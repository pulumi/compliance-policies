...
describe("azurenative.advisor.v20160712preview.Suppression.disallowPreviewResource", function() {
    const policy = policies.azurenative.advisor.v20160712preview.Suppression.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-advisor-v20160712preview-suppression-disallow-preview-resource");
    });
