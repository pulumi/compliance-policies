...
describe("azurenative.agfoodplatform.v20200512preview.Extension.disallowPreviewResource", function() {
    const policy = policies.azurenative.agfoodplatform.v20200512preview.Extension.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-agfoodplatform-v20200512preview-extension-disallow-preview-resource");
    });
