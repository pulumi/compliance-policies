...
describe("azurenative.agfoodplatform.v20200512preview.FarmBeatsModel.disallowPreviewResource", function() {
    const policy = policies.azurenative.agfoodplatform.v20200512preview.FarmBeatsModel.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-agfoodplatform-v20200512preview-farmbeatsmodel-disallow-preview-resource");
    });
