...
describe("azurenative.alertsmanagement.v20190505preview.ActionRuleByName.disallowPreviewResource", function() {
    const policy = policies.azurenative.alertsmanagement.v20190505preview.ActionRuleByName.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-alertsmanagement-v20190505preview-actionrulebyname-disallow-preview-resource");
    });
