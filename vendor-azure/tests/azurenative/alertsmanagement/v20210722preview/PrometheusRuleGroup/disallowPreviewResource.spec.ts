...
describe("azurenative.alertsmanagement.v20210722preview.PrometheusRuleGroup.disallowPreviewResource", function() {
    const policy = policies.azurenative.alertsmanagement.v20210722preview.PrometheusRuleGroup.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-alertsmanagement-v20210722preview-prometheusrulegroup-disallow-preview-resource");
    });
