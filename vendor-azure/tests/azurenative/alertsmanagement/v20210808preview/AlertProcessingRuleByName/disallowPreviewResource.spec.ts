...
describe("azurenative.alertsmanagement.v20210808preview.AlertProcessingRuleByName.disallowPreviewResource", function() {
    const policy = policies.azurenative.alertsmanagement.v20210808preview.AlertProcessingRuleByName.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-alertsmanagement-v20210808preview-alertprocessingrulebyname-disallow-preview-resource");
    });
