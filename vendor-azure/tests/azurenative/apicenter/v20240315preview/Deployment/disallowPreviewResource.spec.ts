...
describe("azurenative.apicenter.v20240315preview.Deployment.disallowPreviewResource", function () {
    const policy = policies.azurenative.apicenter.v20240315preview.Deployment.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-apicenter-v20240315preview-deployment-disallow-preview-resource");
    });
