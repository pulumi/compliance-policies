...
describe("azurenative.apimanagement.v20180601preview.ApiManagementService.disallowPreviewResource", function() {
    const policy = policies.azurenative.apimanagement.v20180601preview.ApiManagementService.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20180601preview-apimanagementservice-disallow-preview-resource");
    });
