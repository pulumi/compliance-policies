...
describe("azurenative.apimanagement.v20180601preview.ApiOperation.disallowPreviewResource", function() {
    const policy = policies.azurenative.apimanagement.v20180601preview.ApiOperation.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20180601preview-apioperation-disallow-preview-resource");
    });
