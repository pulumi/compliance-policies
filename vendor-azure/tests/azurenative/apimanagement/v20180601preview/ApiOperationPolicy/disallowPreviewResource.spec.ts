...
describe("azurenative.apimanagement.v20180601preview.ApiOperationPolicy.disallowPreviewResource", function() {
    const policy = policies.azurenative.apimanagement.v20180601preview.ApiOperationPolicy.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20180601preview-apioperationpolicy-disallow-preview-resource");
    });
