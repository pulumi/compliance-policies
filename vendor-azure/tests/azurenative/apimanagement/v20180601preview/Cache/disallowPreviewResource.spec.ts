...
describe("azurenative.apimanagement.v20180601preview.Cache.disallowPreviewResource", function() {
    const policy = policies.azurenative.apimanagement.v20180601preview.Cache.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20180601preview-cache-disallow-preview-resource");
    });
