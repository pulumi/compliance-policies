...
describe("azurenative.apimanagement.v20180601preview.Certificate.disallowPreviewResource", function() {
    const policy = policies.azurenative.apimanagement.v20180601preview.Certificate.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20180601preview-certificate-disallow-preview-resource");
    });
