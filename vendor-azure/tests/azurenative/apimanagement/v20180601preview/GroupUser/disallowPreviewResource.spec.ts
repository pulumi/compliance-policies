...
describe("azurenative.apimanagement.v20180601preview.GroupUser.disallowPreviewResource", function() {
    const policy = policies.azurenative.apimanagement.v20180601preview.GroupUser.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20180601preview-groupuser-disallow-preview-resource");
    });
