...
describe("azurenative.apimanagement.v20180601preview.IdentityProvider.disallowPreviewResource", function() {
    const policy = policies.azurenative.apimanagement.v20180601preview.IdentityProvider.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20180601preview-identityprovider-disallow-preview-resource");
    });
