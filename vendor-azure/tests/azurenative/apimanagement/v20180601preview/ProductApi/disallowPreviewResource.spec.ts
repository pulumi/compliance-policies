...
describe("azurenative.apimanagement.v20180601preview.ProductApi.disallowPreviewResource", function() {
    const policy = policies.azurenative.apimanagement.v20180601preview.ProductApi.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20180601preview-productapi-disallow-preview-resource");
    });
