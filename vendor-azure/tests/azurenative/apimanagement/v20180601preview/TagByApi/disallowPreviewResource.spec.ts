...
describe("azurenative.apimanagement.v20180601preview.TagByApi.disallowPreviewResource", function() {
    const policy = policies.azurenative.apimanagement.v20180601preview.TagByApi.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20180601preview-tagbyapi-disallow-preview-resource");
    });
