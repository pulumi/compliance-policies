...
describe("azurenative.apimanagement.v20220901preview.WorkspaceTagApiLink.disallowPreviewResource", function () {
    const policy = policies.azurenative.apimanagement.v20220901preview.WorkspaceTagApiLink.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20220901preview-workspacetagapilink-disallow-preview-resource");
    });
