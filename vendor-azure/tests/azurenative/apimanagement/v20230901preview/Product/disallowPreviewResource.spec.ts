...
describe("azurenative.apimanagement.v20230901preview.Product.disallowPreviewResource", function () {
    const policy = policies.azurenative.apimanagement.v20230901preview.Product.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-apimanagement-v20230901preview-product-disallow-preview-resource");
    });
