...
describe("azurenative.app.v20220101preview.ContainerAppsSourceControl.disallowPreviewResource", function() {
    const policy = policies.azurenative.app.v20220101preview.ContainerAppsSourceControl.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-app-v20220101preview-containerappssourcecontrol-disallow-preview-resource");
    });
