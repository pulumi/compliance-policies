...
describe("azurenative.app.v20230401preview.DaprComponent.disallowPreviewResource", function () {
    const policy = policies.azurenative.app.v20230401preview.DaprComponent.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-app-v20230401preview-daprcomponent-disallow-preview-resource");
    });
