...
describe("azurenative.app.v20230502preview.ConnectedEnvironment.disallowPreviewResource", function () {
    const policy = policies.azurenative.app.v20230502preview.ConnectedEnvironment.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-app-v20230502preview-connectedenvironment-disallow-preview-resource");
    });
