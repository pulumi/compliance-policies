...
describe("azurenative.app.v20240202preview.ManagedEnvironment.disallowPreviewResource", function () {
    const policy = policies.azurenative.app.v20240202preview.ManagedEnvironment.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-app-v20240202preview-managedenvironment-disallow-preview-resource");
    });
