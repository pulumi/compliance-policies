...
describe("azurenative.appplatform.v20230701preview.ApiPortal.disallowPreviewResource", function () {
    ...
    it("policy-config-include", async function () {
        ...
        await assertHasResourceViolation(policy, args, { message: "Azure ApiPortal shouldn't use an unstable API (appplatform.v20230701preview.ApiPortal). A compatible replacement can be found at 'appplatform.ApiPortal'." });
    });
