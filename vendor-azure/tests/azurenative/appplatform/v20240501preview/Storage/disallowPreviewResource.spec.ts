...
describe("azurenative.appplatform.v20240501preview.Storage.disallowPreviewResource", function () {
    const policy = policies.azurenative.appplatform.v20240501preview.Storage.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-appplatform-v20240501preview-storage-disallow-preview-resource");
    });
