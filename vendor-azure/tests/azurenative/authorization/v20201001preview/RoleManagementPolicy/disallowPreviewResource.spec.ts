...
describe("azurenative.authorization.v20201001preview.RoleManagementPolicy.disallowPreviewResource", function () {
    const policy = policies.azurenative.authorization.v20201001preview.RoleManagementPolicy.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-authorization-v20201001preview-rolemanagementpolicy-disallow-preview-resource");
    });
