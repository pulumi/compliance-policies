...
describe("azurenative.azureactivedirectory.v20230517preview.B2CTenant.disallowPreviewResource", function () {
    const policy = policies.azurenative.azureactivedirectory.v20230517preview.B2CTenant.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-azureactivedirectory-v20230517preview-b2ctenant-disallow-preview-resource");
    });
