...
describe("azurenative.azurearcdata.v20230115preview.DataController.disallowPreviewResource", function () {
    const policy = policies.azurenative.azurearcdata.v20230115preview.DataController.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-azurearcdata-v20230115preview-datacontroller-disallow-preview-resource");
    });
