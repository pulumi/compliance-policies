...
describe("azurenative.azuredata.v20190724preview.SqlServer.disallowPreviewResource", function() {
    const policy = policies.azurenative.azuredata.v20190724preview.SqlServer.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-azuredata-v20190724preview-sqlserver-disallow-preview-resource");
    });
