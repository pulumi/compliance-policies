...
describe("azurenative.azuredata.v20190724preview.SqlServerRegistration.disallowPreviewResource", function() {
    const policy = policies.azurenative.azuredata.v20190724preview.SqlServerRegistration.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-azuredata-v20190724preview-sqlserverregistration-disallow-preview-resource");
    });
