...
describe("azurenative.azuredatatransfer.v20231011preview.Connection.disallowPreviewResource", function () {
    const policy = policies.azurenative.azuredatatransfer.v20231011preview.Connection.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-azuredatatransfer-v20231011preview-connection-disallow-preview-resource");
    });
