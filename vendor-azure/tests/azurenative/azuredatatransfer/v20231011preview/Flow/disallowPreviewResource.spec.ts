...
describe("azurenative.azuredatatransfer.v20231011preview.Flow.disallowPreviewResource", function () {
    const policy = policies.azurenative.azuredatatransfer.v20231011preview.Flow.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-azuredatatransfer-v20231011preview-flow-disallow-preview-resource");
    });
