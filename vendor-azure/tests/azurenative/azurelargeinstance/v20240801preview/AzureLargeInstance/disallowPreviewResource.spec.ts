...
describe("azurenative.azurelargeinstance.v20240801preview.AzureLargeInstance.disallowPreviewResource", function () {
    const policy = policies.azurenative.azurelargeinstance.v20240801preview.AzureLargeInstance.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-azurelargeinstance-v20240801preview-azurelargeinstance-disallow-preview-resource");
    });
