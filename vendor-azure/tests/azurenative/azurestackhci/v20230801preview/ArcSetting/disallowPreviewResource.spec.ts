...
describe("azurenative.azurestackhci.v20230801preview.ArcSetting.disallowPreviewResource", function () {
    const policy = policies.azurenative.azurestackhci.v20230801preview.ArcSetting.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-azurestackhci-v20230801preview-arcsetting-disallow-preview-resource");
    });
