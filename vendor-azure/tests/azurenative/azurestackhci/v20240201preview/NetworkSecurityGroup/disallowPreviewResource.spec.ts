...
describe("azurenative.azurestackhci.v20240201preview.NetworkSecurityGroup.disallowPreviewResource", function () {
    const policy = policies.azurenative.azurestackhci.v20240201preview.NetworkSecurityGroup.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-azurestackhci-v20240201preview-networksecuritygroup-disallow-preview-resource");
    });
