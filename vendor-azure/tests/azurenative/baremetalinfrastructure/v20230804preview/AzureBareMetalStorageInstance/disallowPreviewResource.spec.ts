...
describe("azurenative.baremetalinfrastructure.v20230804preview.AzureBareMetalStorageInstance.disallowPreviewResource", function () {
    const policy = policies.azurenative.baremetalinfrastructure.v20230804preview.AzureBareMetalStorageInstance.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-baremetalinfrastructure-v20230804preview-azurebaremetalstorageinstance-disallow-preview-resource");
    });
