...
describe("azurenative.botservice.v20230915preview.BotConnection.disallowPreviewResource", function () {
    const policy = policies.azurenative.botservice.v20230915preview.BotConnection.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-botservice-v20230915preview-botconnection-disallow-preview-resource");
    });
