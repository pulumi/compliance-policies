...
describe("azurenative.cache.v20230501preview.LinkedServer.disallowPreviewResource", function () {
    const policy = policies.azurenative.cache.v20230501preview.LinkedServer.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-cache-v20230501preview-linkedserver-disallow-preview-resource");
    });
