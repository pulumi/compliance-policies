...
describe("azurenative.cache.v20230501preview.PatchSchedule.disallowPreviewResource", function () {
    const policy = policies.azurenative.cache.v20230501preview.PatchSchedule.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-cache-v20230501preview-patchschedule-disallow-preview-resource");
    });
