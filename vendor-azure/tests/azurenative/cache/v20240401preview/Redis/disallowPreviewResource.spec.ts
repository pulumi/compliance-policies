...
describe("azurenative.cache.v20240401preview.Redis.disallowPreviewResource", function () {
    const policy = policies.azurenative.cache.v20240401preview.Redis.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-cache-v20240401preview-redis-disallow-preview-resource");
    });
