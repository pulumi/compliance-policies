...
describe("azurenative.cdn.v20230701preview.OriginGroup.disallowPreviewResource", function () {
    const policy = policies.azurenative.cdn.v20230701preview.OriginGroup.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-cdn-v20230701preview-origingroup-disallow-preview-resource");
    });
