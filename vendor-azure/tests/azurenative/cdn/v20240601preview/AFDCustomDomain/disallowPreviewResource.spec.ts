...
describe("azurenative.cdn.v20240601preview.AFDCustomDomain.disallowPreviewResource", function () {
    const policy = policies.azurenative.cdn.v20240601preview.AFDCustomDomain.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-cdn-v20240601preview-afdcustomdomain-disallow-preview-resource");
    });
