...
describe("azurenative.cdn.v20240601preview.KeyGroup.disallowPreviewResource", function () {
    const policy = policies.azurenative.cdn.v20240601preview.KeyGroup.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-cdn-v20240601preview-keygroup-disallow-preview-resource");
    });
