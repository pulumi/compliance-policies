...
describe("azurenative.chaos.v20240322preview.Capability.disallowPreviewResource", function () {
    const policy = policies.azurenative.chaos.v20240322preview.Capability.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-chaos-v20240322preview-capability-disallow-preview-resource");
    });
