...
describe("azurenative.cloudngfw.v20220829preview.CertificateObjectGlobalRulestack.disallowPreviewResource", function () {
    const policy = policies.azurenative.cloudngfw.v20220829preview.CertificateObjectGlobalRulestack.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-cloudngfw-v20220829preview-certificateobjectglobalrulestack-disallow-preview-resource");
    });
