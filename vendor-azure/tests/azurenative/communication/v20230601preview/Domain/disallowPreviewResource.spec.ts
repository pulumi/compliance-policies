...
describe("azurenative.communication.v20230601preview.Domain.disallowPreviewResource", function () {
    const policy = policies.azurenative.communication.v20230601preview.Domain.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-communication-v20230601preview-domain-disallow-preview-resource");
    });
