...
describe("azurenative.confidentialledger.v20240709preview.ManagedCCF.disallowPreviewResource", function () {
    const policy = policies.azurenative.confidentialledger.v20240709preview.ManagedCCF.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-confidentialledger-v20240709preview-managedccf-disallow-preview-resource");
    });
