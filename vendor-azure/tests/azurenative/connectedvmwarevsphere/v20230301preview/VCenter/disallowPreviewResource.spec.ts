...
describe("azurenative.connectedvmwarevsphere.v20230301preview.VCenter.disallowPreviewResource", function () {
    const policy = policies.azurenative.connectedvmwarevsphere.v20230301preview.VCenter.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-connectedvmwarevsphere-v20230301preview-vcenter-disallow-preview-resource");
    });
