...
describe("azurenative.connectedvmwarevsphere.v20230301preview.VirtualMachineTemplate.disallowPreviewResource", function () {
    const policy = policies.azurenative.connectedvmwarevsphere.v20230301preview.VirtualMachineTemplate.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-connectedvmwarevsphere-v20230301preview-virtualmachinetemplate-disallow-preview-resource");
    });
