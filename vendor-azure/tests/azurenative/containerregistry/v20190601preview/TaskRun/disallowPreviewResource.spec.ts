...
describe("azurenative.containerregistry.v20190601preview.TaskRun.disallowPreviewResource", function() {
    const policy = policies.azurenative.containerregistry.v20190601preview.TaskRun.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-containerregistry-v20190601preview-taskrun-disallow-preview-resource");
    });
