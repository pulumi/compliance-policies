...
describe("azurenative.containerregistry.v20230601preview.ImportPipeline.disallowPreviewResource", function () {
    const policy = policies.azurenative.containerregistry.v20230601preview.ImportPipeline.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-containerregistry-v20230601preview-importpipeline-disallow-preview-resource");
    });
