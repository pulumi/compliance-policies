...
describe("azurenative.containerregistry.v20230601preview.PipelineRun.disallowPreviewResource", function () {
    const policy = policies.azurenative.containerregistry.v20230601preview.PipelineRun.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-containerregistry-v20230601preview-pipelinerun-disallow-preview-resource");
    });
