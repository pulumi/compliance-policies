...
describe("azurenative.containerregistry.v20231101preview.PrivateEndpointConnection.disallowPreviewResource", function () {
    const policy = policies.azurenative.containerregistry.v20231101preview.PrivateEndpointConnection.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-containerregistry-v20231101preview-privateendpointconnection-disallow-preview-resource");
    });
