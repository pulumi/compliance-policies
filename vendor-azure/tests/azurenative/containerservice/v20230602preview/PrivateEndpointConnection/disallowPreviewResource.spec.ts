...
describe("azurenative.containerservice.v20230602preview.PrivateEndpointConnection.disallowPreviewResource", function () {
    ...
    it("policy-config-include", async function () {
        ...
        await assertHasResourceViolation(policy, args, { message: "Azure PrivateEndpointConnection shouldn't use an unstable API (containerservice.v20230602preview.PrivateEndpointConnection). A compatible replacement can be found at 'containerservice.PrivateEndpointConnection'." });
    });
