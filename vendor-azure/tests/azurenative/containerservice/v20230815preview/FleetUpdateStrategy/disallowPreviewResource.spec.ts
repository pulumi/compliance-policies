...
describe("azurenative.containerservice.v20230815preview.FleetUpdateStrategy.disallowPreviewResource", function () {
    const policy = policies.azurenative.containerservice.v20230815preview.FleetUpdateStrategy.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-containerservice-v20230815preview-fleetupdatestrategy-disallow-preview-resource");
    });
