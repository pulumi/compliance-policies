...
describe("azurenative.containerservice.v20240202preview.Fleet.disallowPreviewResource", function () {
    const policy = policies.azurenative.containerservice.v20240202preview.Fleet.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-containerservice-v20240202preview-fleet-disallow-preview-resource");
    });
