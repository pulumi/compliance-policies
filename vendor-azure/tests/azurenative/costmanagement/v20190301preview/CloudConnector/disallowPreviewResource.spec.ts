...
describe("azurenative.costmanagement.v20190301preview.CloudConnector.disallowPreviewResource", function() {
    const policy = policies.azurenative.costmanagement.v20190301preview.CloudConnector.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-costmanagement-v20190301preview-cloudconnector-disallow-preview-resource");
    });
