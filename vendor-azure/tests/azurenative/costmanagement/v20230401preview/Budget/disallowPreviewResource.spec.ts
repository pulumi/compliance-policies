...
describe("azurenative.costmanagement.v20230401preview.Budget.disallowPreviewResource", function () {
    const policy = policies.azurenative.costmanagement.v20230401preview.Budget.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-costmanagement-v20230401preview-budget-disallow-preview-resource");
    });
