...
describe("azurenative.dashboard.v20221001preview.ManagedPrivateEndpoint.disallowPreviewResource", function () {
    const policy = policies.azurenative.dashboard.v20221001preview.ManagedPrivateEndpoint.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-dashboard-v20221001preview-managedprivateendpoint-disallow-preview-resource");
    });
