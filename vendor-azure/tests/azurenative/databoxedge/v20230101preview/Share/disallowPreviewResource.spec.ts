...
describe("azurenative.databoxedge.v20230101preview.Share.disallowPreviewResource", function() {
    const policy = policies.azurenative.databoxedge.v20230101preview.Share.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-databoxedge-v20230101preview-share-disallow-preview-resource");
    });
