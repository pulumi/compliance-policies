...
describe("azurenative.datashare.v20201001preview.ADLSGen2StorageAccountDataSetMapping.disallowPreviewResource", function() {
    const policy = policies.azurenative.datashare.v20201001preview.ADLSGen2StorageAccountDataSetMapping.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-datashare-v20201001preview-adlsgen2storageaccountdatasetmapping-disallow-preview-resource");
    });
