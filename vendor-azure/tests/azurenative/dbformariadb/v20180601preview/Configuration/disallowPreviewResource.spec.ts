...
describe("azurenative.dbformariadb.v20180601preview.Configuration.disallowPreviewResource", function() {
    const policy = policies.azurenative.dbformariadb.v20180601preview.Configuration.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-dbformariadb-v20180601preview-configuration-disallow-preview-resource");
    });
