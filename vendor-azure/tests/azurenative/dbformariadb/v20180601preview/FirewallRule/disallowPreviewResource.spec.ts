...
describe("azurenative.dbformariadb.v20180601preview.FirewallRule.disallowPreviewResource", function() {
    const policy = policies.azurenative.dbformariadb.v20180601preview.FirewallRule.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-dbformariadb-v20180601preview-firewallrule-disallow-preview-resource");
    });
