...
describe("azurenative.dbforpostgresql.v20201005privatepreview.ServerGroup.disallowPreviewResource", function() {
    const policy = policies.azurenative.dbforpostgresql.v20201005privatepreview.ServerGroup.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-dbforpostgresql-v20201005privatepreview-servergroup-disallow-preview-resource");
    });
