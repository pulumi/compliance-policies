...
describe("azurenative.delegatednetwork.v20230518preview.OrchestratorInstanceServiceDetails.disallowPreviewResource", function () {
    const policy = policies.azurenative.delegatednetwork.v20230518preview.OrchestratorInstanceServiceDetails.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-delegatednetwork-v20230518preview-orchestratorinstanceservicedetails-disallow-preview-resource");
    });
