...
describe("azurenative.desktopvirtualization.v20231004preview.PrivateEndpointConnectionByHostPool.disallowPreviewResource", function () {
    const policy = policies.azurenative.desktopvirtualization.v20231004preview.PrivateEndpointConnectionByHostPool.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-desktopvirtualization-v20231004preview-privateendpointconnectionbyhostpool-disallow-preview-resource");
    });
