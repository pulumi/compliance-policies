...
describe("azurenative.desktopvirtualization.v20240116preview.MSIXPackage.disallowPreviewResource", function () {
    const policy = policies.azurenative.desktopvirtualization.v20240116preview.MSIXPackage.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-desktopvirtualization-v20240116preview-msixpackage-disallow-preview-resource");
    });
