...
describe("azurenative.devcenter.v20231001preview.ProjectEnvironmentType.disallowPreviewResource", function () {
    const policy = policies.azurenative.devcenter.v20231001preview.ProjectEnvironmentType.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-devcenter-v20231001preview-projectenvironmenttype-disallow-preview-resource");
    });
