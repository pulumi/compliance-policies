...
describe("azurenative.devcenter.v20240501preview.Gallery.disallowPreviewResource", function () {
    const policy = policies.azurenative.devcenter.v20240501preview.Gallery.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-devcenter-v20240501preview-gallery-disallow-preview-resource");
    });
