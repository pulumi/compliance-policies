...
describe("azurenative.devhub.v20240801preview.Workflow.disallowPreviewResource", function () {
    const policy = policies.azurenative.devhub.v20240801preview.Workflow.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-devhub-v20240801preview-workflow-disallow-preview-resource");
    });
