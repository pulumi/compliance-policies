...
describe("azurenative.deviceregistry.v20240901preview.DiscoveredAssetEndpointProfile.disallowPreviewResource", function () {
    const policy = policies.azurenative.deviceregistry.v20240901preview.DiscoveredAssetEndpointProfile.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-deviceregistry-v20240901preview-discoveredassetendpointprofile-disallow-preview-resource");
    });
