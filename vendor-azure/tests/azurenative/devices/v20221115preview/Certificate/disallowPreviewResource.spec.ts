...
describe("azurenative.devices.v20221115preview.Certificate.disallowPreviewResource", function () {
    ...
    it("#1", async function () {
        ...
        await assertHasResourceViolation(policy, args, {
            message: "Azure Certificate shouldn't use an unstable API (devices.v20221115preview.Certificate). A compatible replacement can be found at 'devices.Certificate'.",
        });
    });
});
