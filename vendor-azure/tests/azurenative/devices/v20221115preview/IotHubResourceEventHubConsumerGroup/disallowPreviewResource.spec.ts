...
describe("azurenative.devices.v20221115preview.IotHubResourceEventHubConsumerGroup.disallowPreviewResource", function () {
    const policy = policies.azurenative.devices.v20221115preview.IotHubResourceEventHubConsumerGroup.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-devices-v20221115preview-iothubresourceeventhubconsumergroup-disallow-preview-resource");
    });
