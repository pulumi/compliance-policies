...
describe("azurenative.devices.v20230301preview.DpsCertificate.disallowPreviewResource", function() {
    const policy = policies.azurenative.devices.v20230301preview.DpsCertificate.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-devices-v20230301preview-dpscertificate-disallow-preview-resource");
    });
