...
describe("azurenative.documentdb.v20231115preview.CassandraResourceCassandraKeyspace.disallowPreviewResource", function () {
    const policy = policies.azurenative.documentdb.v20231115preview.CassandraResourceCassandraKeyspace.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-documentdb-v20231115preview-cassandraresourcecassandrakeyspace-disallow-preview-resource");
    });
