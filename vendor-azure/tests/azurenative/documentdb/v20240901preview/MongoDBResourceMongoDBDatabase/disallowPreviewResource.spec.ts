...
describe("azurenative.documentdb.v20240901preview.MongoDBResourceMongoDBDatabase.disallowPreviewResource", function () {
    const policy = policies.azurenative.documentdb.v20240901preview.MongoDBResourceMongoDBDatabase.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-documentdb-v20240901preview-mongodbresourcemongodbdatabase-disallow-preview-resource");
    });
