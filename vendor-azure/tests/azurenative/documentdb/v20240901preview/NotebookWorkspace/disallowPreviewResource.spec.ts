...
describe("azurenative.documentdb.v20240901preview.NotebookWorkspace.disallowPreviewResource", function () {
    const policy = policies.azurenative.documentdb.v20240901preview.NotebookWorkspace.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-documentdb-v20240901preview-notebookworkspace-disallow-preview-resource");
    });
