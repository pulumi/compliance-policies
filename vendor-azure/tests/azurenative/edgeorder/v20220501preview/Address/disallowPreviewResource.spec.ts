...
describe("azurenative.edgeorder.v20220501preview.Address.disallowPreviewResource", function() {
    const policy = policies.azurenative.edgeorder.v20220501preview.Address.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-edgeorder-v20220501preview-address-disallow-preview-resource");
    });
