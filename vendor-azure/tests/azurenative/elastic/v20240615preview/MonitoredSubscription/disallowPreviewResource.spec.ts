...
describe("azurenative.elastic.v20240615preview.MonitoredSubscription.disallowPreviewResource", function () {
    const policy = policies.azurenative.elastic.v20240615preview.MonitoredSubscription.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-elastic-v20240615preview-monitoredsubscription-disallow-preview-resource");
    });
