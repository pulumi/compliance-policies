...
describe("azurenative.elastic.v20240615preview.OpenAI.disallowPreviewResource", function () {
    const policy = policies.azurenative.elastic.v20240615preview.OpenAI.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-elastic-v20240615preview-openai-disallow-preview-resource");
    });
