...
describe("azurenative.eventgrid.v20230601preview.Channel.disallowPreviewResource", function () {
    const policy = policies.azurenative.eventgrid.v20230601preview.Channel.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-eventgrid-v20230601preview-channel-disallow-preview-resource");
    });
