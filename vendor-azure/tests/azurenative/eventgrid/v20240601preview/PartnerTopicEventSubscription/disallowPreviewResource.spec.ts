...
describe("azurenative.eventgrid.v20240601preview.PartnerTopicEventSubscription.disallowPreviewResource", function () {
    const policy = policies.azurenative.eventgrid.v20240601preview.PartnerTopicEventSubscription.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-eventgrid-v20240601preview-partnertopiceventsubscription-disallow-preview-resource");
    });
