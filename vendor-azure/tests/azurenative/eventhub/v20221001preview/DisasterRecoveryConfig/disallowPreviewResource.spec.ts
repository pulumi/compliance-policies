...
describe("azurenative.eventhub.v20221001preview.DisasterRecoveryConfig.disallowPreviewResource", function() {
    const policy = policies.azurenative.eventhub.v20221001preview.DisasterRecoveryConfig.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-eventhub-v20221001preview-disasterrecoveryconfig-disallow-preview-resource");
    });
