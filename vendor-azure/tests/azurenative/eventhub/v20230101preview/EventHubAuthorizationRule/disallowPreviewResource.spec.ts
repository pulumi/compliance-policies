...
describe("azurenative.eventhub.v20230101preview.EventHubAuthorizationRule.disallowPreviewResource", function () {
    const policy = policies.azurenative.eventhub.v20230101preview.EventHubAuthorizationRule.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-eventhub-v20230101preview-eventhubauthorizationrule-disallow-preview-resource");
    });
