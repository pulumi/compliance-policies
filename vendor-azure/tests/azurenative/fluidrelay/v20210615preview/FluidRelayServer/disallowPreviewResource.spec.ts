...
describe("azurenative.fluidrelay.v20210615preview.FluidRelayServer.disallowPreviewResource", function() {
    const policy = policies.azurenative.fluidrelay.v20210615preview.FluidRelayServer.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-fluidrelay-v20210615preview-fluidrelayserver-disallow-preview-resource");
    });
