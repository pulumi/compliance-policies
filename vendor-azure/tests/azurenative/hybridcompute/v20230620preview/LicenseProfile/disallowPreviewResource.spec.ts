...
describe("azurenative.hybridcompute.v20230620preview.LicenseProfile.disallowPreviewResource", function () {
    const policy = policies.azurenative.hybridcompute.v20230620preview.LicenseProfile.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-hybridcompute-v20230620preview-licenseprofile-disallow-preview-resource");
    });
