...
describe("azurenative.hybridconnectivity.v20220501preview.Endpoint.disallowPreviewResource", function() {
    const policy = policies.azurenative.hybridconnectivity.v20220501preview.Endpoint.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-hybridconnectivity-v20220501preview-endpoint-disallow-preview-resource");
    });
