...
describe("azurenative.hybridcontainerservice.v20231115preview.VirtualNetworkRetrieve.disallowPreviewResource", function () {
    const policy = policies.azurenative.hybridcontainerservice.v20231115preview.VirtualNetworkRetrieve.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-hybridcontainerservice-v20231115preview-virtualnetworkretrieve-disallow-preview-resource");
    });
