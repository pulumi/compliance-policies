...
describe("azurenative.insights.v20191017preview.PrivateLinkScope.disallowPreviewResource", function() {
    const policy = policies.azurenative.insights.v20191017preview.PrivateLinkScope.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-insights-v20191017preview-privatelinkscope-disallow-preview-resource");
    });
