...
describe("azurenative.insights.v20230101preview.ActivityLogAlert.disallowPreviewResource", function() {
    const policy = policies.azurenative.insights.v20230101preview.ActivityLogAlert.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-insights-v20230101preview-activitylogalert-disallow-preview-resource");
    });
