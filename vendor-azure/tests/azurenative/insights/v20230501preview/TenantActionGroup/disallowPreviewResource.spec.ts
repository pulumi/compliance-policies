...
describe("azurenative.insights.v20230501preview.TenantActionGroup.disallowPreviewResource", function () {
    const policy = policies.azurenative.insights.v20230501preview.TenantActionGroup.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-insights-v20230501preview-tenantactiongroup-disallow-preview-resource");
    });
