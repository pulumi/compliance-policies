...
describe("azurenative.insights.v20230901preview.ActionGroup.disallowPreviewResource", function () {
    const policy = policies.azurenative.insights.v20230901preview.ActionGroup.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-insights-v20230901preview-actiongroup-disallow-preview-resource");
    });
