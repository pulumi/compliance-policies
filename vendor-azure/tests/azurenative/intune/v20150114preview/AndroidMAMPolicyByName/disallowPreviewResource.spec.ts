...
describe("azurenative.intune.v20150114preview.AndroidMAMPolicyByName.disallowPreviewResource", function() {
    const policy = policies.azurenative.intune.v20150114preview.AndroidMAMPolicyByName.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-intune-v20150114preview-androidmampolicybyname-disallow-preview-resource");
    });
