...
describe("azurenative.iotoperationsdataprocessor.v20231004preview.Instance.disallowPreviewResource", function () {
    const policy = policies.azurenative.iotoperationsdataprocessor.v20231004preview.Instance.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-iotoperationsdataprocessor-v20231004preview-instance-disallow-preview-resource");
    });
