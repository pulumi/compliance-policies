...
describe("azurenative.iotoperationsmq.v20231004preview.BrokerAuthentication.disallowPreviewResource", function () {
    const policy = policies.azurenative.iotoperationsmq.v20231004preview.BrokerAuthentication.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-iotoperationsmq-v20231004preview-brokerauthentication-disallow-preview-resource");
    });
