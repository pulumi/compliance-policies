...
describe("azurenative.iotoperationsmq.v20231004preview.DataLakeConnectorTopicMap.disallowPreviewResource", function () {
    const policy = policies.azurenative.iotoperationsmq.v20231004preview.DataLakeConnectorTopicMap.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-iotoperationsmq-v20231004preview-datalakeconnectortopicmap-disallow-preview-resource");
    });
