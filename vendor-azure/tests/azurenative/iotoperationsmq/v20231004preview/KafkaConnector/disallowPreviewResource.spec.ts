...
describe("azurenative.iotoperationsmq.v20231004preview.KafkaConnector.disallowPreviewResource", function () {
    const policy = policies.azurenative.iotoperationsmq.v20231004preview.KafkaConnector.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-iotoperationsmq-v20231004preview-kafkaconnector-disallow-preview-resource");
    });
