...
describe("azurenative.kusto.v20180907preview.EventHubConnection.disallowPreviewResource", function() {
    const policy = policies.azurenative.kusto.v20180907preview.EventHubConnection.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-kusto-v20180907preview-eventhubconnection-disallow-preview-resource");
    });
