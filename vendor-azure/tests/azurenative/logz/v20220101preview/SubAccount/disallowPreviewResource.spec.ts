...
describe("azurenative.logz.v20220101preview.SubAccount.disallowPreviewResource", function() {
    const policy = policies.azurenative.logz.v20220101preview.SubAccount.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-logz-v20220101preview-subaccount-disallow-preview-resource");
    });
