...
describe("azurenative.maintenance.v20231001preview.ConfigurationAssignmentsForSubscription.disallowPreviewResource", function () {
    const policy = policies.azurenative.maintenance.v20231001preview.ConfigurationAssignmentsForSubscription.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-maintenance-v20231001preview-configurationassignmentsforsubscription-disallow-preview-resource");
    });
