...
describe("azurenative.maps.v20231201preview.Creator.disallowPreviewResource", function () {
    const policy = policies.azurenative.maps.v20231201preview.Creator.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-maps-v20231201preview-creator-disallow-preview-resource");
    });
