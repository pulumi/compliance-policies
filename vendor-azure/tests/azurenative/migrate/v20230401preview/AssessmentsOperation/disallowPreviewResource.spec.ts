...
describe("azurenative.migrate.v20230401preview.AssessmentsOperation.disallowPreviewResource", function () {
    const policy = policies.azurenative.migrate.v20230401preview.AssessmentsOperation.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-migrate-v20230401preview-assessmentsoperation-disallow-preview-resource");
    });
