...
describe("azurenative.mobilepacketcore.v20230515preview.NetworkFunction.disallowPreviewResource", function () {
    const policy = policies.azurenative.mobilepacketcore.v20230515preview.NetworkFunction.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-mobilepacketcore-v20230515preview-networkfunction-disallow-preview-resource");
    });
