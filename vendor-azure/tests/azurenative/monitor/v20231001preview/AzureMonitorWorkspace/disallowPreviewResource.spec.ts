...
describe("azurenative.monitor.v20231001preview.AzureMonitorWorkspace.disallowPreviewResource", function () {
    const policy = policies.azurenative.monitor.v20231001preview.AzureMonitorWorkspace.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-monitor-v20231001preview-azuremonitorworkspace-disallow-preview-resource");
    });
