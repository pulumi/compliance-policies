...
describe("azurenative.netapp.v20230701preview.Backup.disallowPreviewResource", function () {
    const policy = policies.azurenative.netapp.v20230701preview.Backup.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-netapp-v20230701preview-backup-disallow-preview-resource");
    });
