...
describe("azurenative.network.v20230801preview.NetworkSecurityPerimeter.disallowPreviewResource", function () {
    const policy = policies.azurenative.network.v20230801preview.NetworkSecurityPerimeter.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-network-v20230801preview-networksecurityperimeter-disallow-preview-resource");
    });
