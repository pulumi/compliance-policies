...
describe("azurenative.networkcloud.v20230501preview.BareMetalMachineKeySet.disallowPreviewResource", function () {
    const policy = policies.azurenative.networkcloud.v20230501preview.BareMetalMachineKeySet.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-networkcloud-v20230501preview-baremetalmachinekeyset-disallow-preview-resource");
    });
