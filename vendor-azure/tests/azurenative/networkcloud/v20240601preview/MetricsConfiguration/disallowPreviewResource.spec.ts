...
describe("azurenative.networkcloud.v20240601preview.MetricsConfiguration.disallowPreviewResource", function () {
    const policy = policies.azurenative.networkcloud.v20240601preview.MetricsConfiguration.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-networkcloud-v20240601preview-metricsconfiguration-disallow-preview-resource");
    });
