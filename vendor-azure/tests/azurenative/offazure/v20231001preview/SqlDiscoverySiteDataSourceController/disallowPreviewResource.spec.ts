...
describe("azurenative.offazure.v20231001preview.SqlDiscoverySiteDataSourceController.disallowPreviewResource", function () {
    const policy = policies.azurenative.offazure.v20231001preview.SqlDiscoverySiteDataSourceController.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-offazure-v20231001preview-sqldiscoverysitedatasourcecontroller-disallow-preview-resource");
    });
