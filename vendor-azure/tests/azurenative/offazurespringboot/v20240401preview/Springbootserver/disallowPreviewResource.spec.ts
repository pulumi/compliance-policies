...
describe("azurenative.offazurespringboot.v20240401preview.Springbootserver.disallowPreviewResource", function () {
    const policy = policies.azurenative.offazurespringboot.v20240401preview.Springbootserver.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-offazurespringboot-v20240401preview-springbootserver-disallow-preview-resource");
    });
