...
describe("azurenative.operationalinsights.v20151101preview.DataSource.disallowPreviewResource", function() {
    const policy = policies.azurenative.operationalinsights.v20151101preview.DataSource.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-operationalinsights-v20151101preview-datasource-disallow-preview-resource");
    });
