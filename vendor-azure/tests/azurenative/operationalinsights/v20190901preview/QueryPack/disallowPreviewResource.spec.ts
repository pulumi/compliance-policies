...
describe("azurenative.operationalinsights.v20190901preview.QueryPack.disallowPreviewResource", function() {
    const policy = policies.azurenative.operationalinsights.v20190901preview.QueryPack.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-operationalinsights-v20190901preview-querypack-disallow-preview-resource");
    });
