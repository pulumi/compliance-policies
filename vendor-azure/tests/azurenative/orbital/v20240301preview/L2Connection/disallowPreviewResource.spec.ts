...
describe("azurenative.orbital.v20240301preview.L2Connection.disallowPreviewResource", function () {
    const policy = policies.azurenative.orbital.v20240301preview.L2Connection.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-orbital-v20240301preview-l2connection-disallow-preview-resource");
    });
