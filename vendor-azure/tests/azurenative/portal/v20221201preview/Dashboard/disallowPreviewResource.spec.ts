...
describe("azurenative.portal.v20221201preview.Dashboard.disallowPreviewResource", function () {
    const policy = policies.azurenative.portal.v20221201preview.Dashboard.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-portal-v20221201preview-dashboard-disallow-preview-resource");
    });
