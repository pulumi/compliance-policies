...
describe("azurenative.programmableconnectivity.v20240115preview.OperatorApiConnection.disallowPreviewResource", function () {
    const policy = policies.azurenative.programmableconnectivity.v20240115preview.OperatorApiConnection.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-programmableconnectivity-v20240115preview-operatorapiconnection-disallow-preview-resource");
    });
