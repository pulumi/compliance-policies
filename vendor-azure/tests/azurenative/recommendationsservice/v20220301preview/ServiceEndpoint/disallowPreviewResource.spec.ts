...
describe("azurenative.recommendationsservice.v20220301preview.ServiceEndpoint.disallowPreviewResource", function() {
    const policy = policies.azurenative.recommendationsservice.v20220301preview.ServiceEndpoint.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-recommendationsservice-v20220301preview-serviceendpoint-disallow-preview-resource");
    });
