...
describe("azurenative.recoveryservices.v20240430preview.ProtectionIntent.disallowPreviewResource", function () {
    const policy = policies.azurenative.recoveryservices.v20240430preview.ProtectionIntent.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-recoveryservices-v20240430preview-protectionintent-disallow-preview-resource");
    });
