...
describe("azurenative.redhatopenshift.v20230701preview.MachinePool.disallowPreviewResource", function () {
    const policy = policies.azurenative.redhatopenshift.v20230701preview.MachinePool.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-redhatopenshift-v20230701preview-machinepool-disallow-preview-resource");
    });
