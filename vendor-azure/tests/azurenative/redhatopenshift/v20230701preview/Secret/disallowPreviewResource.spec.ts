...
describe("azurenative.redhatopenshift.v20230701preview.Secret.disallowPreviewResource", function () {
    const policy = policies.azurenative.redhatopenshift.v20230701preview.Secret.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-redhatopenshift-v20230701preview-secret-disallow-preview-resource");
    });
