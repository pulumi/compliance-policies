...
describe("azurenative.resources.v20190601preview.TemplateSpecVersion.disallowPreviewResource", function() {
    const policy = policies.azurenative.resources.v20190601preview.TemplateSpecVersion.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-resources-v20190601preview-templatespecversion-disallow-preview-resource");
    });
