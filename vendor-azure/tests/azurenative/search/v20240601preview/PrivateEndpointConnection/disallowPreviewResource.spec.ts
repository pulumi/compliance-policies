...
describe("azurenative.search.v20240601preview.PrivateEndpointConnection.disallowPreviewResource", function () {
    const policy = policies.azurenative.search.v20240601preview.PrivateEndpointConnection.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-search-v20240601preview-privateendpointconnection-disallow-preview-resource");
    });
