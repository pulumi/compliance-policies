...
describe("azurenative.security.v20210701preview.SecurityConnector.disallowPreviewResource", function() {
    const policy = policies.azurenative.security.v20210701preview.SecurityConnector.disallowPreviewResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "azurenative-security-v20210701preview-securityconnector-disallow-preview-resource");
    });
