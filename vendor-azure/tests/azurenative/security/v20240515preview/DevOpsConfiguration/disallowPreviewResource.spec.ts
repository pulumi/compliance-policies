...
describe("azurenative.security.v20240515preview.DevOpsConfiguration.disallowPreviewResource", function () {
    const policy = policies.azurenative.security.v20240515preview.DevOpsConfiguration.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-security-v20240515preview-devopsconfiguration-disallow-preview-resource");
    });
