...
describe("azurenative.securityinsights.v20220801preview.OfficePowerBIDataConnector.disallowPreviewResource", function () {
    const policy = policies.azurenative.securityinsights.v20220801preview.OfficePowerBIDataConnector.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-securityinsights-v20220801preview-officepowerbidataconnector-disallow-preview-resource");
    });
