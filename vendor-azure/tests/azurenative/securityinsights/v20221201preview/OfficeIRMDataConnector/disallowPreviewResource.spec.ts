...
describe("azurenative.securityinsights.v20221201preview.OfficeIRMDataConnector.disallowPreviewResource", function () {
    const policy = policies.azurenative.securityinsights.v20221201preview.OfficeIRMDataConnector.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-securityinsights-v20221201preview-officeirmdataconnector-disallow-preview-resource");
    });
