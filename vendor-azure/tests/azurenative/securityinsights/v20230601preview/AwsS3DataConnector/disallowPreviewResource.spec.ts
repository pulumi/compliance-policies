...
describe("azurenative.securityinsights.v20230601preview.AwsS3DataConnector.disallowPreviewResource", function () {
    const policy = policies.azurenative.securityinsights.v20230601preview.AwsS3DataConnector.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-securityinsights-v20230601preview-awss3dataconnector-disallow-preview-resource");
    });
