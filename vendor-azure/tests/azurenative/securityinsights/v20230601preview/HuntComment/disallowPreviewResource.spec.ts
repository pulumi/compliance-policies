...
describe("azurenative.securityinsights.v20230601preview.HuntComment.disallowPreviewResource", function () {
    const policy = policies.azurenative.securityinsights.v20230601preview.HuntComment.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-securityinsights-v20230601preview-huntcomment-disallow-preview-resource");
    });
