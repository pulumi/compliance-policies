...
describe("azurenative.securityinsights.v20240101preview.RestApiPollerDataConnector.disallowPreviewResource", function () {
    const policy = policies.azurenative.securityinsights.v20240101preview.RestApiPollerDataConnector.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-securityinsights-v20240101preview-restapipollerdataconnector-disallow-preview-resource");
    });
