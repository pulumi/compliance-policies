...
describe("azurenative.securityinsights.v20241001preview.GCPDataConnector.disallowPreviewResource", function () {
    const policy = policies.azurenative.securityinsights.v20241001preview.GCPDataConnector.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-securityinsights-v20241001preview-gcpdataconnector-disallow-preview-resource");
    });
