...
describe("azurenative.securityinsights.v20250101preview.ActivityCustomEntityQuery.disallowPreviewResource", function () {
    const policy = policies.azurenative.securityinsights.v20250101preview.ActivityCustomEntityQuery.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-securityinsights-v20250101preview-activitycustomentityquery-disallow-preview-resource");
    });
