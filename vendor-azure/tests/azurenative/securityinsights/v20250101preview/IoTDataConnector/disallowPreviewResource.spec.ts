...
describe("azurenative.securityinsights.v20250101preview.IoTDataConnector.disallowPreviewResource", function () {
    const policy = policies.azurenative.securityinsights.v20250101preview.IoTDataConnector.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-securityinsights-v20250101preview-iotdataconnector-disallow-preview-resource");
    });
