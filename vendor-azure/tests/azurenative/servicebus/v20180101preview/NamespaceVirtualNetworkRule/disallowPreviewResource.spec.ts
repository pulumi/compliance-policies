...
describe("azurenative.servicebus.v20180101preview.NamespaceVirtualNetworkRule.disallowPreviewResource", function () {
    const policy = policies.azurenative.servicebus.v20180101preview.NamespaceVirtualNetworkRule.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-servicebus-v20180101preview-namespacevirtualnetworkrule-disallow-preview-resource");
    });
