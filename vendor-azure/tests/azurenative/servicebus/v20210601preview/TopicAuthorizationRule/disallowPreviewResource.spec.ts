...
describe("azurenative.servicebus.v20210601preview.TopicAuthorizationRule.disallowPreviewResource", function () {
    const policy = policies.azurenative.servicebus.v20210601preview.TopicAuthorizationRule.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-servicebus-v20210601preview-topicauthorizationrule-disallow-preview-resource");
    });
