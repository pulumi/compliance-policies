...
describe("azurenative.servicebus.v20221001preview.Topic.disallowPreviewResource", function () {
    const policy = policies.azurenative.servicebus.v20221001preview.Topic.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-servicebus-v20221001preview-topic-disallow-preview-resource");
    });
