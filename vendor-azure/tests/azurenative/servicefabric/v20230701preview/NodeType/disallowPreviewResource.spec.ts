...
describe("azurenative.servicefabric.v20230701preview.NodeType.disallowPreviewResource", function () {
    const policy = policies.azurenative.servicefabric.v20230701preview.NodeType.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-servicefabric-v20230701preview-nodetype-disallow-preview-resource");
    });
