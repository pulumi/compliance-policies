...
describe("azurenative.servicefabric.v20240901preview.ManagedClusterApplicationTypeVersion.disallowPreviewResource", function () {
    const policy = policies.azurenative.servicefabric.v20240901preview.ManagedClusterApplicationTypeVersion.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-servicefabric-v20240901preview-managedclusterapplicationtypeversion-disallow-preview-resource");
    });
