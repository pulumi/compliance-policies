...
describe("azurenative.servicelinker.v20230401preview.Connector.disallowPreviewResource", function () {
    const policy = policies.azurenative.servicelinker.v20230401preview.Connector.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-servicelinker-v20230401preview-connector-disallow-preview-resource");
    });
