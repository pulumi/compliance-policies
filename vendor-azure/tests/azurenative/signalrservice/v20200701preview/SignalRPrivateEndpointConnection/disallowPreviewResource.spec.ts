...
describe("azurenative.signalrservice.v20200701preview.SignalRPrivateEndpointConnection.disallowPreviewResource", function () {
    const policy = policies.azurenative.signalrservice.v20200701preview.SignalRPrivateEndpointConnection.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-signalrservice-v20200701preview-signalrprivateendpointconnection-disallow-preview-resource");
    });
