...
describe("azurenative.signalrservice.v20240101preview.SignalRCustomDomain.disallowPreviewResource", function () {
    const policy = policies.azurenative.signalrservice.v20240101preview.SignalRCustomDomain.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-signalrservice-v20240101preview-signalrcustomdomain-disallow-preview-resource");
    });
