...
describe("azurenative.sovereign.v20250227preview.LandingZoneConfigurationOperation.disallowPreviewResource", function () {
    const policy = policies.azurenative.sovereign.v20250227preview.LandingZoneConfigurationOperation.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sovereign-v20250227preview-landingzoneconfigurationoperation-disallow-preview-resource");
    });
