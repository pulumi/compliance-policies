...
describe("azurenative.sql.v20170301preview.BackupLongTermRetentionPolicy.disallowPreviewResource", function () {
    const policy = policies.azurenative.sql.v20170301preview.BackupLongTermRetentionPolicy.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sql-v20170301preview-backuplongtermretentionpolicy-disallow-preview-resource");
    });
