...
describe("azurenative.sql.v20221101preview.EncryptionProtector.disallowPreviewResource", function () {
    const policy = policies.azurenative.sql.v20221101preview.EncryptionProtector.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sql-v20221101preview-encryptionprotector-disallow-preview-resource");
    });
