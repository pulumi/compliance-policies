...
describe("azurenative.sql.v20221101preview.Job.disallowPreviewResource", function () {
    const policy = policies.azurenative.sql.v20221101preview.Job.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sql-v20221101preview-job-disallow-preview-resource");
    });
