...
describe("azurenative.sql.v20221101preview.WorkloadGroup.disallowPreviewResource", function () {
    const policy = policies.azurenative.sql.v20221101preview.WorkloadGroup.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sql-v20221101preview-workloadgroup-disallow-preview-resource");
    });
