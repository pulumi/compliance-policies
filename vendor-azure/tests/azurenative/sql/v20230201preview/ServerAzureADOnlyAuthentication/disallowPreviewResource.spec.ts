...
describe("azurenative.sql.v20230201preview.ServerAzureADOnlyAuthentication.disallowPreviewResource", function () {
    const policy = policies.azurenative.sql.v20230201preview.ServerAzureADOnlyAuthentication.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sql-v20230201preview-serverazureadonlyauthentication-disallow-preview-resource");
    });
