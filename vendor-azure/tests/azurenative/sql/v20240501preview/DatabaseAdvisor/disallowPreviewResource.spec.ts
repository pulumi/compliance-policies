...
describe("azurenative.sql.v20240501preview.DatabaseAdvisor.disallowPreviewResource", function () {
    const policy = policies.azurenative.sql.v20240501preview.DatabaseAdvisor.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sql-v20240501preview-databaseadvisor-disallow-preview-resource");
    });
