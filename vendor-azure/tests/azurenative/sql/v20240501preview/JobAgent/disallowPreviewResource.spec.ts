...
describe("azurenative.sql.v20240501preview.JobAgent.disallowPreviewResource", function () {
    const policy = policies.azurenative.sql.v20240501preview.JobAgent.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sql-v20240501preview-jobagent-disallow-preview-resource");
    });
