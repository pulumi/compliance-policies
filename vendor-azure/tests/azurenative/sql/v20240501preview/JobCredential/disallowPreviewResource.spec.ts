...
describe("azurenative.sql.v20240501preview.JobCredential.disallowPreviewResource", function () {
    ...
    it("policy-config-include", async function () {
        ...
        await assertHasResourceViolation(policy, args, { message: "Azure JobCredential shouldn't use an unstable API (sql.v20240501preview.JobCredential). A compatible replacement can be found at 'sql.JobCredential'." });
    });
