...
describe("azurenative.sql.v20240501preview.JobStep.disallowPreviewResource", function () {
    const policy = policies.azurenative.sql.v20240501preview.JobStep.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sql-v20240501preview-jobstep-disallow-preview-resource");
    });
