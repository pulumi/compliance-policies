...
describe("azurenative.sqlvirtualmachine.v20220801preview.SqlVirtualMachine.disallowPreviewResource", function () {
    const policy = policies.azurenative.sqlvirtualmachine.v20220801preview.SqlVirtualMachine.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-sqlvirtualmachine-v20220801preview-sqlvirtualmachine-disallow-preview-resource");
    });
