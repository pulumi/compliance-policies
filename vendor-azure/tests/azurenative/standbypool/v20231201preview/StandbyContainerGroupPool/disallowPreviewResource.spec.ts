...
describe("azurenative.standbypool.v20231201preview.StandbyContainerGroupPool.disallowPreviewResource", function () {
    const policy = policies.azurenative.standbypool.v20231201preview.StandbyContainerGroupPool.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-standbypool-v20231201preview-standbycontainergrouppool-disallow-preview-resource");
    });
