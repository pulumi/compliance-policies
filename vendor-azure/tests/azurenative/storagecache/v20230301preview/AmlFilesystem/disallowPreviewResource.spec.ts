...
describe("azurenative.storagecache.v20230301preview.amlFilesystem.disallowPreviewResource", function() {
    ...
    it("#1", async function() {
        ...
        await assertHasResourceViolation(policy, args, { message: "Kubernetes amlFilesystem shouldn't use an unstable API (storagecache.v20230301preview.amlFilesystem)." });
    });
});
