...
describe("azurenative.storagecache.v20231101preview.AmlFilesystem.disallowPreviewResource", function () {
    const policy = policies.azurenative.storagecache.v20231101preview.AmlFilesystem.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-storagecache-v20231101preview-amlfilesystem-disallow-preview-resource");
    });
