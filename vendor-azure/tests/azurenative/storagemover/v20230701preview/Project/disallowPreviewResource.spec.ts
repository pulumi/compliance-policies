...
describe("azurenative.storagemover.v20230701preview.Project.disallowPreviewResource", function () {
    const policy = policies.azurenative.storagemover.v20230701preview.Project.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-storagemover-v20230701preview-project-disallow-preview-resource");
    });
