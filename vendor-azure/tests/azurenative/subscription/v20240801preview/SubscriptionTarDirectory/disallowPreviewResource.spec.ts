...
describe("azurenative.subscription.v20240801preview.SubscriptionTarDirectory.disallowPreviewResource", function () {
    const policy = policies.azurenative.subscription.v20240801preview.SubscriptionTarDirectory.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-subscription-v20240801preview-subscriptiontardirectory-disallow-preview-resource");
    });
