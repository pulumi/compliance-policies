...
describe("azurenative.synapse.v20210401preview.KustoPool.disallowPreviewResource", function () {
    ...
    it("policy-config-include", async function () {
        ...
        await assertHasResourceViolation(policy, args, { message: "Azure KustoPool shouldn't use an unstable API (synapse.v20210401preview.KustoPool). A compatible replacement can be found at 'synapse.KustoPool'." });
    });
