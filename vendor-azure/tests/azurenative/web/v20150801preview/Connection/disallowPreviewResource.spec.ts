...
describe("azurenative.web.v20150801preview.Connection.disallowPreviewResource", function () {
    ...
    it("policy-config-include", async function () {
        ...
        await assertHasResourceViolation(policy, args, { message: "Azure Connection shouldn't use an unstable API (web.v20150801preview.Connection). A compatible replacement can be found at 'web.Connection'." });
    });
