...
describe("azurenative.workloads.v20231001preview.ACSSBackupConnection.disallowPreviewResource", function () {
    const policy = policies.azurenative.workloads.v20231001preview.ACSSBackupConnection.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-workloads-v20231001preview-acssbackupconnection-disallow-preview-resource");
    });
