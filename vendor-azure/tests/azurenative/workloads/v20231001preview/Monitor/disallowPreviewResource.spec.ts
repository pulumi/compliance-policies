...
describe("azurenative.workloads.v20231001preview.Monitor.disallowPreviewResource", function () {
    const policy = policies.azurenative.workloads.v20231001preview.Monitor.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-workloads-v20231001preview-monitor-disallow-preview-resource");
    });
