...
describe("azurenative.workloads.v20231201preview.ProviderInstance.disallowPreviewResource", function () {
    const policy = policies.azurenative.workloads.v20231201preview.ProviderInstance.disallowPreviewResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "azurenative-workloads-v20231201preview-providerinstance-disallow-preview-resource");
    });
