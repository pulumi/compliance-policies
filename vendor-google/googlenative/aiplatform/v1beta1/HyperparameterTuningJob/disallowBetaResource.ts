...
import { HyperparameterTuningJob } from "@pulumi/google-native/aiplatform/v1beta1";

/**
 * Disallow the use of non-stable (Beta) resouces (aiplatform.v1beta1.HyperparameterTuningJob).
 *
 * @severity medium
 * @frameworks none
