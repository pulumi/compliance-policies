...
import { ApiConfigIamMember } from "@pulumi/google-native/apigateway/v1beta";
...
export const disallowBetaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(ApiConfigIamMember, (_, args, reportViolation) => {
