...
import { HubIamBinding } from "@pulumi/google-native/networkconnectivity/v1alpha1";
...
export const disallowAlphaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(HubIamBinding, (_, args, reportViolation) => {
