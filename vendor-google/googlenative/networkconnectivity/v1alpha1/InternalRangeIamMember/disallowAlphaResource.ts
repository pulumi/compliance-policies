...
import { InternalRangeIamMember } from "@pulumi/google-native/networkconnectivity/v1alpha1";
...
export const disallowAlphaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(InternalRangeIamMember, (_, args, reportViolation) => {
