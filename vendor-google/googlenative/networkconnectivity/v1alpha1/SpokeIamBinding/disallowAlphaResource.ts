...
import { SpokeIamBinding } from "@pulumi/google-native/networkconnectivity/v1alpha1";
...
export const disallowAlphaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(SpokeIamBinding, (_, args, reportViolation) => {
