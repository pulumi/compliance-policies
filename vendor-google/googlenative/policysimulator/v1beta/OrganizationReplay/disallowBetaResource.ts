...
import { OrganizationReplay } from "@pulumi/google-native/policysimulator/v1beta";

/**
 * Disallow the use of non-stable (Beta) resouces (policysimulator.v1beta.OrganizationReplay).
 *
 * @severity medium
 * @frameworks none
