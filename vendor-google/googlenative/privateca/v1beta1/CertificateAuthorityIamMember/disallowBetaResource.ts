...
import { CertificateAuthorityIamMember } from "@pulumi/google-native/privateca/v1beta1";
...
export const disallowBetaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(CertificateAuthorityIamMember, (_, args, reportViolation) => {
