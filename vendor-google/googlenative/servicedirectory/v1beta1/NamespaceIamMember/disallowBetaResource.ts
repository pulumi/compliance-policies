...
import { NamespaceIamMember } from "@pulumi/google-native/servicedirectory/v1beta1";
...
export const disallowBetaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(NamespaceIamMember, (_, args, reportViolation) => {
