...
import { NamespaceIamPolicy } from "@pulumi/google-native/servicedirectory/v1beta1";
...
export const disallowBetaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(NamespaceIamPolicy, (_, args, reportViolation) => {
