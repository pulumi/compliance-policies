...
describe("googlenative.aiplatform.v1beta1.HyperparameterTuningJob.disallowBetaResource", function () {
    const policy = policies.googlenative.aiplatform.v1beta1.HyperparameterTuningJob.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-aiplatform-v1beta1-hyperparametertuningjob-disallow-beta-resource");
    });
