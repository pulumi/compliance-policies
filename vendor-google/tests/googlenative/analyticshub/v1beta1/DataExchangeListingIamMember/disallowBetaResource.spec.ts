...
describe("googlenative.analyticshub.v1beta1.DataExchangeListingIamMember.disallowBetaResource", function () {
    const policy = policies.googlenative.analyticshub.v1beta1.DataExchangeListingIamMember.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-analyticshub-v1beta1-dataexchangelistingiammember-disallow-beta-resource");
    });
