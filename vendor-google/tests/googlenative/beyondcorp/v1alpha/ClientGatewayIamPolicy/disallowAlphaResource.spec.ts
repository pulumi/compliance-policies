...
describe("googlenative.beyondcorp.v1alpha.ClientGatewayIamPolicy.disallowAlphaResource", function () {
    const policy = policies.googlenative.beyondcorp.v1alpha.ClientGatewayIamPolicy.disallowAlphaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-beyondcorp-v1alpha-clientgatewayiampolicy-disallow-alpha-resource");
    });
