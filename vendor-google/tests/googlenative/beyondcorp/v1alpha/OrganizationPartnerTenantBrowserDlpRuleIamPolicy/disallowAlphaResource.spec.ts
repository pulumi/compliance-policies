...
describe("googlenative.beyondcorp.v1alpha.OrganizationPartnerTenantBrowserDlpRuleIamPolicy.disallowAlphaResource", function () {
    const policy = policies.googlenative.beyondcorp.v1alpha.OrganizationPartnerTenantBrowserDlpRuleIamPolicy.disallowAlphaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-beyondcorp-v1alpha-organizationpartnertenantbrowserdlpruleiampolicy-disallow-alpha-resource");
    });
