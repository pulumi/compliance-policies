...
describe("googlenative.cloudresourcemanager.v2beta1.FolderIamBinding.disallowBetaResource", function () {
    const policy = policies.googlenative.cloudresourcemanager.v2beta1.FolderIamBinding.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-cloudresourcemanager-v2beta1-folderiambinding-disallow-beta-resource");
    });
