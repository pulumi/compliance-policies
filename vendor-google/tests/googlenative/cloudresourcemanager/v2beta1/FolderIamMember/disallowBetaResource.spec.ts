...
describe("googlenative.cloudresourcemanager.v2beta1.FolderIamMember.disallowBetaResource", function () {
    const policy = policies.googlenative.cloudresourcemanager.v2beta1.FolderIamMember.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-cloudresourcemanager-v2beta1-folderiammember-disallow-beta-resource");
    });
