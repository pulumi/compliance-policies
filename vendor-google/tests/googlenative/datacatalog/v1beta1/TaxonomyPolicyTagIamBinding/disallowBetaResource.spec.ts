...
describe("googlenative.datacatalog.v1beta1.TaxonomyPolicyTagIamBinding.disallowBetaResource", function () {
    const policy = policies.googlenative.datacatalog.v1beta1.TaxonomyPolicyTagIamBinding.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-datacatalog-v1beta1-taxonomypolicytagiambinding-disallow-beta-resource");
    });
