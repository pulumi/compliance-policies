...
describe("googlenative.datamigration.v1beta1.ConnectionProfileIamMember.disallowBetaResource", function () {
    const policy = policies.googlenative.datamigration.v1beta1.ConnectionProfileIamMember.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-datamigration-v1beta1-connectionprofileiammember-disallow-beta-resource");
    });
