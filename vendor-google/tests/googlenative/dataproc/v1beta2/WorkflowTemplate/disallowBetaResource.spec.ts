...
describe("googlenative.dataproc.v1beta2.WorkflowTemplate.disallowBetaResource", function () {
    const policy = policies.googlenative.dataproc.v1beta2.WorkflowTemplate.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-dataproc-v1beta2-workflowtemplate-disallow-beta-resource");
    });
