...
describe("googlenative.deploymentmanager.v2beta.CompositeType.disallowBetaResource", function () {
    const policy = policies.googlenative.deploymentmanager.v2beta.CompositeType.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-deploymentmanager-v2beta-compositetype-disallow-beta-resource");
    });
