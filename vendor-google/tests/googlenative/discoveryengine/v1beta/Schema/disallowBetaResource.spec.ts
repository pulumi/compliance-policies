...
describe("googlenative.discoveryengine.v1beta.Schema.disallowBetaResource", function () {
    const policy = policies.googlenative.discoveryengine.v1beta.Schema.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-discoveryengine-v1beta-schema-disallow-beta-resource");
    });
