...
describe("googlenative.eventarc.v1beta1.TriggerIamPolicy.disallowBetaResource", function () {
    const policy = policies.googlenative.eventarc.v1beta1.TriggerIamPolicy.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-eventarc-v1beta1-triggeriampolicy-disallow-beta-resource");
    });
