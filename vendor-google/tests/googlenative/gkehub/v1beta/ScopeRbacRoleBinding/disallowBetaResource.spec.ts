...
describe("googlenative.gkehub.v1beta.ScopeRbacRoleBinding.disallowBetaResource", function () {
    const policy = policies.googlenative.gkehub.v1beta.ScopeRbacRoleBinding.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-gkehub-v1beta-scoperbacrolebinding-disallow-beta-resource");
    });
