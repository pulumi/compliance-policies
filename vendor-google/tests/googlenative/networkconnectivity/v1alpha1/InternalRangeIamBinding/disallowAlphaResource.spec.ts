...
describe("googlenative.networkconnectivity.v1alpha1.InternalRangeIamBinding.disallowAlphaResource", function () {
    const policy = policies.googlenative.networkconnectivity.v1alpha1.InternalRangeIamBinding.disallowAlphaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-networkconnectivity-v1alpha1-internalrangeiambinding-disallow-alpha-resource");
    });
