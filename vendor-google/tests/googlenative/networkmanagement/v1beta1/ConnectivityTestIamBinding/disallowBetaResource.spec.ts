...
describe("googlenative.networkmanagement.v1beta1.ConnectivityTestIamBinding.disallowBetaResource", function () {
    const policy = policies.googlenative.networkmanagement.v1beta1.ConnectivityTestIamBinding.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-networkmanagement-v1beta1-connectivitytestiambinding-disallow-beta-resource");
    });
