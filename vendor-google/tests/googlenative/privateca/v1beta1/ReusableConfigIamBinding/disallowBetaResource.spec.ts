...
describe("googlenative.privateca.v1beta1.ReusableConfigIamBinding.disallowBetaResource", function () {
    const policy = policies.googlenative.privateca.v1beta1.ReusableConfigIamBinding.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-privateca-v1beta1-reusableconfigiambinding-disallow-beta-resource");
    });
