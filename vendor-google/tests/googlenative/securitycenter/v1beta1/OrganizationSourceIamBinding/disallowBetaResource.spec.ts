...
describe("googlenative.securitycenter.v1beta1.OrganizationSourceIamBinding.disallowBetaResource", function () {
    const policy = policies.googlenative.securitycenter.v1beta1.OrganizationSourceIamBinding.disallowBetaResource;

    it("name", async function () {
        assertResourcePolicyName(policy, "googlenative-securitycenter-v1beta1-organizationsourceiambinding-disallow-beta-resource");
    });
