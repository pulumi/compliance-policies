...
import { MutatingAdmissionPolicyBinding } from "@pulumi/kubernetes/admissionregistration/v1alpha1";
...
export const disallowAlphaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(MutatingAdmissionPolicyBinding, (_, args, reportViolation) => {
