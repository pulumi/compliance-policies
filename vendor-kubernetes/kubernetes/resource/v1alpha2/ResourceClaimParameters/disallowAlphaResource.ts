...
import { ResourceClaimParameters } from "@pulumi/kubernetes/resource/v1alpha2";
...
export const disallowAlphaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(ResourceClaimParameters, (_, args, reportViolation) => {
