...
import { ResourceClassParametersList } from "@pulumi/kubernetes/resource/v1alpha2";
...
export const disallowAlphaResource: ResourceValidationPolicy = policyManager.registerPolicy({
    resourceValidationPolicy: {
        ...
        validateResource: validateResourceOfType(ResourceClassParametersList, (_, args, reportViolation) => {
