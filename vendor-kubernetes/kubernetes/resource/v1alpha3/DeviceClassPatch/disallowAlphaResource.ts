...
import { DeviceClassPatch } from "@pulumi/kubernetes/resource/v1alpha3";

/**
 * Disallow the use of non-stable (Alpha) Kubernetes resouces (resource.v1alpha3.DeviceClassPatch).
 *
 * @severity medium
 * @frameworks none
