...
import { VolumeAttributesClassList } from "@pulumi/kubernetes/storage/v1alpha1";

/**
 * Disallow the use of non-stable (Alpha) Kubernetes resouces (storage.v1alpha1.VolumeAttributesClassList).
 *
 * @severity medium
 * @frameworks none
