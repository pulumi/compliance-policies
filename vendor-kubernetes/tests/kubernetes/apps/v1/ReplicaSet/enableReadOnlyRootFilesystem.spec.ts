...
describe("kubernetes.apps.v1.ReplicaSet.enableReadOnlyRootFilesystem", function() {
    const policy = policies.kubernetes.apps.v1.ReplicaSet.enableReadOnlyRootFilesystem;

    it("name", async function() {
        assertResourcePolicyName(policy, "kubernetes-apps-v1-replicaset-enable-read-only-root-filesystem");
    });
