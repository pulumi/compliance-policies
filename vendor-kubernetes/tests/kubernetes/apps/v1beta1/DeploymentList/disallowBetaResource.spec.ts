...
describe("kubernetes.apps.v1beta1.DeploymentList.disallowBetaResource", function() {
    const policy = policies.kubernetes.apps.v1beta1.DeploymentList.disallowBetaResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "kubernetes-apps-v1beta1-deploymentlist-disallow-beta-resource");
    });
