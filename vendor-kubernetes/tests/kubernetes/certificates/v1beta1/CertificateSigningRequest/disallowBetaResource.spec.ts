...
describe("kubernetes.certificates.v1beta1.CertificateSigningRequest.disallowBetaResource", function() {
    const policy = policies.kubernetes.certificates.v1beta1.CertificateSigningRequest.disallowBetaResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "kubernetes-certificates-v1beta1-certificatesigningrequest-disallow-beta-resource");
    });
