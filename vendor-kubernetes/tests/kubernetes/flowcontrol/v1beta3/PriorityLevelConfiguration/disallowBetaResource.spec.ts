...
describe("kubernetes.flowcontrol.v1beta3.PriorityLevelConfiguration.disallowBetaResource", function() {
    const policy = policies.kubernetes.flowcontrol.v1beta3.PriorityLevelConfiguration.disallowBetaResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "kubernetes-flowcontrol-v1beta3-prioritylevelconfiguration-disallow-beta-resource");
    });
