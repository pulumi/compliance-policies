...
describe("kubernetes.node.v1alpha1.RuntimeClassPatch.disallowAlphaResource", function() {
    const policy = policies.kubernetes.node.v1alpha1.RuntimeClassPatch.disallowAlphaResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "kubernetes-node-v1alpha1-runtimeclasspatch-disallow-alpha-resource");
    });
