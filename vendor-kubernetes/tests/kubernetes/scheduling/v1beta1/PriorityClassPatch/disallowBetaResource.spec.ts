...
describe("kubernetes.scheduling.v1beta1.PriorityClassPatch.disallowBetaResource", function() {
    const policy = policies.kubernetes.scheduling.v1beta1.PriorityClassPatch.disallowBetaResource;

    it("name", async function() {
        assertResourcePolicyName(policy, "kubernetes-scheduling-v1beta1-priorityclasspatch-disallow-beta-resource");
    });
